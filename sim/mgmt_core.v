//--------------------------------------------------------------------------------
// Auto-generated by Migen (7507a2b) & LiteX (2cf6ca7) on 2021-11-08 20:45:01
//--------------------------------------------------------------------------------
module mgmt_core(
	input wire core_clk,
	input wire core_rst,
...
reg [3:0] main_maskwren0 = 4'd0;
reg main_wren_b0 = 1'd0;
reg main_cs_b0 = 1'd0;
wire [31:0] main_datain1;
wire [31:0] main_dataout1;
reg [3:0] main_maskwren1 = 4'd0;
reg main_wren_b1 = 1'd0;
reg main_cs_b1 = 1'd0;
...
always @(*) begin
	main_wren_b0 = 1'd0;
	if ((main_bus_adr[8] == 1'd0)) begin
		main_wren_b0 = (~((main_bus_we & main_bus_stb) & main_bus_cyc));
	end
end
always @(*) begin
...
always @(*) begin
	main_maskwren0 = 4'd0;
	main_maskwren0[0] = main_bus_sel[0];
	main_maskwren0[1] = main_bus_sel[1];
	main_maskwren0[2] = main_bus_sel[2];
	main_maskwren0[3] = main_bus_sel[3];
end
assign main_datain1 = main_bus_dat_w[31:0];
always @(*) begin
	main_wren_b1 = 1'd0;
	if ((main_bus_adr[8] == 1'd1)) begin
		main_wren_b1 = (~((main_bus_we & main_bus_stb) & main_bus_cyc));
	end
end
always @(*) begin
	main_cs_b1 = 1'd0;
...
always @(*) begin
	main_maskwren1 = 4'd0;
	main_maskwren1[0] = main_bus_sel[0];
	main_maskwren1[1] = main_bus_sel[1];
	main_maskwren1[2] = main_bus_sel[2];
	main_maskwren1[3] = main_bus_sel[3];
end
...
sram_1rw1r_32_256_8_sky130 sram_1rw1r_32_256_8_sky130(
	.addr0(main_bus_adr[7:0]),
	.clk0(sys_clk),
	.csb0(main_cs_b0),
	.din0(main_datain0),
	.web0(main_wren_b0),
	.wmask0(main_maskwren0),
	.dout0(main_dataout0)
);
