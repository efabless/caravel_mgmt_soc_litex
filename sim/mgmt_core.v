...
always @(posedge sys_clk) begin
	...
	{mgmtsoc_tx_tick, mgmtsoc_tx_phase} <= 22'd4123168;
	if (mgmtsoc_tx_enable) begin
		{mgmtsoc_tx_tick, mgmtsoc_tx_phase} <= (mgmtsoc_tx_phase + 22'd4123168);
	end
	...
	if (mgmtsoc_rx_enable) begin
		{mgmtsoc_rx_tick, mgmtsoc_rx_phase} <= (mgmtsoc_rx_phase + 22'd4123168);
	end
