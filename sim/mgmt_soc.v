//--------------------------------------------------------------------------------
// Auto-generated by Migen (7507a2b) & LiteX (92c8ad1) on 2021-11-03 20:45:01
//--------------------------------------------------------------------------------
module top(
	input wire sys_clk,
	input wire sys_rst,
...
reg csrbank4_mmap_dummy_bits0_re = 1'd0;
wire [7:0] csrbank4_mmap_dummy_bits0_r;
reg csrbank4_mmap_dummy_bits0_we = 1'd0;
wire [7:0] csrbank4_mmap_dummy_bits0_w;
reg csrbank4_master_cs0_re = 1'd0;
wire csrbank4_master_cs0_r;
reg csrbank4_master_cs0_we = 1'd0;
wire csrbank4_master_cs0_w;
reg csrbank4_master_phyconfig0_re = 1'd0;
wire [23:0] csrbank4_master_phyconfig0_r;
reg csrbank4_master_phyconfig0_we = 1'd0;
wire [23:0] csrbank4_master_phyconfig0_w;
reg csrbank4_master_status_re = 1'd0;
wire [1:0] csrbank4_master_status_r;
reg csrbank4_master_status_we = 1'd0;
wire [1:0] csrbank4_master_status_w;
wire csrbank4_sel;
wire [13:0] interface5_bank_bus_adr;
wire interface5_bank_bus_we;
wire [31:0] interface5_bank_bus_dat_w;
reg [31:0] interface5_bank_bus_dat_r = 32'd0;
reg csrbank5_clk_divisor0_re = 1'd0;
wire [7:0] csrbank5_clk_divisor0_r;
reg csrbank5_clk_divisor0_we = 1'd0;
wire [7:0] csrbank5_clk_divisor0_w;
wire csrbank5_sel;
...
wire [2:0] csrbank8_out0_r;
reg csrbank8_out0_we = 1'd0;
wire [2:0] csrbank8_out0_w;
wire csrbank8_sel;
...
always @(*) begin
	...
	slave_sel[1] <= (shared_adr[29:14] == 16'd33280);
end
...
assign mgmtsoc_litespimmap_bus_cyc = (shared_cyc & slave_sel[0]);
assign mgmtsoc_wishbone_cyc = (shared_cyc & slave_sel[1]);
assign shared_err = (mgmtsoc_litespimmap_bus_err | mgmtsoc_wishbone_err);
assign wait_1 = ((shared_stb & shared_cyc) & (~shared_ack));
always @(*) begin
	shared_dat_r <= 32'd0;
	shared_ack <= 1'd0;
	error <= 1'd0;
	shared_ack <= (mgmtsoc_litespimmap_bus_ack | mgmtsoc_wishbone_ack);
	shared_dat_r <= (({32{slave_sel_r[0]}} & mgmtsoc_litespimmap_bus_dat_r) | ({32{slave_sel_r[1]}} & mgmtsoc_wishbone_dat_r));
	if (done) begin
...
assign csrbank4_mmap_dummy_bits0_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_mmap_dummy_bits0_we <= 1'd0;
	csrbank4_mmap_dummy_bits0_re <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank4_mmap_dummy_bits0_re <= interface4_bank_bus_we;
		csrbank4_mmap_dummy_bits0_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_master_cs0_r = interface4_bank_bus_dat_w[0];
always @(*) begin
	csrbank4_master_cs0_re <= 1'd0;
	csrbank4_master_cs0_we <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank4_master_cs0_re <= interface4_bank_bus_we;
		csrbank4_master_cs0_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_master_phyconfig0_r = interface4_bank_bus_dat_w[23:0];
always @(*) begin
	csrbank4_master_phyconfig0_re <= 1'd0;
	csrbank4_master_phyconfig0_we <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank4_master_phyconfig0_re <= interface4_bank_bus_we;
		csrbank4_master_phyconfig0_we <= (~interface4_bank_bus_we);
	end
end
assign mgmtsoc_master_rxtx_r = interface4_bank_bus_dat_w[31:0];
always @(*) begin
	mgmtsoc_master_rxtx_we <= 1'd0;
	mgmtsoc_master_rxtx_re <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 2'd3))) begin
		mgmtsoc_master_rxtx_re <= interface4_bank_bus_we;
		mgmtsoc_master_rxtx_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_master_status_r = interface4_bank_bus_dat_w[1:0];
always @(*) begin
	csrbank4_master_status_we <= 1'd0;
	csrbank4_master_status_re <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 3'd4))) begin
		csrbank4_master_status_re <= interface4_bank_bus_we;
		csrbank4_master_status_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_mmap_dummy_bits0_w = mgmtsoc_litespimmap_storage[7:0];
assign csrbank4_master_cs0_w = mgmtsoc_master_cs_storage;
...
assign csrbank4_master_phyconfig0_w = mgmtsoc_master_phyconfig_storage[23:0];
always @(*) begin
...
assign csrbank4_master_status_w = mgmtsoc_master_status_status[1:0];
assign mgmtsoc_master_status_we = csrbank4_master_status_we;
assign csrbank5_sel = (interface5_bank_bus_adr[13:9] == 3'd5);
assign csrbank5_clk_divisor0_r = interface5_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank5_clk_divisor0_re <= 1'd0;
	csrbank5_clk_divisor0_we <= 1'd0;
	if ((csrbank5_sel & (interface5_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank5_clk_divisor0_re <= interface5_bank_bus_we;
		csrbank5_clk_divisor0_we <= (~interface5_bank_bus_we);
	end
end
assign csrbank5_clk_divisor0_w = mgmtsoc_litespisdrphycore_storage[7:0];
...
assign csrbank6_load0_w = mgmtsoc_timer_load_storage[31:0];
assign csrbank6_reload0_w = mgmtsoc_timer_reload_storage[31:0];
assign csrbank6_en0_w = mgmtsoc_timer_en_storage;
assign csrbank6_update_value0_w = mgmtsoc_timer_update_value_storage;
assign csrbank6_value_w = mgmtsoc_timer_value_status[31:0];
assign mgmtsoc_timer_value_we = csrbank6_value_we;
assign mgmtsoc_timer_status_status = mgmtsoc_timer_zero0;
assign csrbank6_ev_status_w = mgmtsoc_timer_status_status;
assign mgmtsoc_timer_status_we = csrbank6_ev_status_we;
assign mgmtsoc_timer_pending_status = mgmtsoc_timer_zero1;
assign csrbank6_ev_pending_w = mgmtsoc_timer_pending_status;
assign mgmtsoc_timer_pending_we = csrbank6_ev_pending_we;
assign mgmtsoc_timer_zero2 = mgmtsoc_timer_enable_storage;
assign csrbank6_ev_enable0_w = mgmtsoc_timer_enable_storage;
assign csrbank7_sel = (interface7_bank_bus_adr[13:9] == 3'd7);
assign mgmtsoc_uart_rxtx_r = interface7_bank_bus_dat_w[7:0];
always @(*) begin
	mgmtsoc_uart_rxtx_re <= 1'd0;
	mgmtsoc_uart_rxtx_we <= 1'd0;
	if ((csrbank7_sel & (interface7_bank_bus_adr[8:0] == 1'd0))) begin
		mgmtsoc_uart_rxtx_re <= interface7_bank_bus_we;
		mgmtsoc_uart_rxtx_we <= (~interface7_bank_bus_we);
	end
end
...
assign csrbank7_txfull_w = mgmtsoc_uart_txfull_status;
assign mgmtsoc_uart_txfull_we = csrbank7_txfull_we;
assign csrbank7_rxempty_w = mgmtsoc_uart_rxempty_status;
assign mgmtsoc_uart_rxempty_we = csrbank7_rxempty_we;
always @(*) begin
...
assign csrbank7_ev_status_w = mgmtsoc_uart_status_status[1:0];
assign mgmtsoc_uart_status_we = csrbank7_ev_status_we;
always @(*) begin
...
assign csrbank7_ev_pending_w = mgmtsoc_uart_pending_status[1:0];
assign mgmtsoc_uart_pending_we = csrbank7_ev_pending_we;
assign mgmtsoc_uart_tx2 = mgmtsoc_uart_enable_storage[0];
assign mgmtsoc_uart_rx2 = mgmtsoc_uart_enable_storage[1];
assign csrbank7_ev_enable0_w = mgmtsoc_uart_enable_storage[1:0];
assign csrbank7_txempty_w = mgmtsoc_uart_txempty_status;
assign mgmtsoc_uart_txempty_we = csrbank7_txempty_we;
assign csrbank7_rxfull_w = mgmtsoc_uart_rxfull_status;
assign mgmtsoc_uart_rxfull_we = csrbank7_rxfull_we;
assign csrbank8_sel = (interface8_bank_bus_adr[13:9] == 4'd8);
assign csrbank8_out0_r = interface8_bank_bus_dat_w[2:0];
always @(*) begin
...
assign csrbank8_out0_w = user_irq_ena_storage[2:0];
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed0 <= mgmtsoc_picorv32_idbus_adr;
		end
		default: begin
			array_muxed0 <= uart_bridge_wishbone_adr;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed1 <= mgmtsoc_picorv32_idbus_dat_w;
		end
		default: begin
			array_muxed1 <= uart_bridge_wishbone_dat_w;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed2 <= mgmtsoc_picorv32_idbus_sel;
		end
		default: begin
			array_muxed2 <= uart_bridge_wishbone_sel;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed3 <= mgmtsoc_picorv32_idbus_cyc;
		end
		default: begin
			array_muxed3 <= uart_bridge_wishbone_cyc;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed4 <= mgmtsoc_picorv32_idbus_stb;
		end
		default: begin
			array_muxed4 <= uart_bridge_wishbone_stb;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed5 <= mgmtsoc_picorv32_idbus_we;
		end
		default: begin
			array_muxed5 <= uart_bridge_wishbone_we;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed6 <= mgmtsoc_picorv32_idbus_cti;
		end
		default: begin
			array_muxed6 <= uart_bridge_wishbone_cti;
		end
	endcase
end
always @(*) begin
	...
	case (grant)
		1'd0: begin
			array_muxed7 <= mgmtsoc_picorv32_idbus_bte;
		end
		default: begin
			array_muxed7 <= uart_bridge_wishbone_bte;
		end
	endcase
end
...
always @(posedge sdrio_clk) begin
	...
	mgmtsoc_litespisdrphycore_dq_i[1] <= spiflash_miso;
end
...
always @(posedge sys_clk_1) begin
	...
	if (csrbank4_sel) begin
		case (interface4_bank_bus_adr[8:0])
			1'd0: begin
				interface4_bank_bus_dat_r <= csrbank4_mmap_dummy_bits0_w;
			end
			1'd1: begin
				interface4_bank_bus_dat_r <= csrbank4_master_cs0_w;
			end
			2'd2: begin
				interface4_bank_bus_dat_r <= csrbank4_master_phyconfig0_w;
			end
			2'd3: begin
				interface4_bank_bus_dat_r <= mgmtsoc_master_rxtx_w;
			end
			3'd4: begin
				interface4_bank_bus_dat_r <= csrbank4_master_status_w;
			end
		endcase
	end
	if (csrbank4_mmap_dummy_bits0_re) begin
		mgmtsoc_litespimmap_storage[7:0] <= csrbank4_mmap_dummy_bits0_r;
	end
	mgmtsoc_litespimmap_re <= csrbank4_mmap_dummy_bits0_re;
	if (csrbank4_master_cs0_re) begin
		mgmtsoc_master_cs_storage <= csrbank4_master_cs0_r;
	end
	mgmtsoc_master_cs_re <= csrbank4_master_cs0_re;
	if (csrbank4_master_phyconfig0_re) begin
		mgmtsoc_master_phyconfig_storage[23:0] <= csrbank4_master_phyconfig0_r;
	end
	mgmtsoc_master_phyconfig_re <= csrbank4_master_phyconfig0_re;
	mgmtsoc_master_status_re <= csrbank4_master_status_re;
	interface5_bank_bus_dat_r <= 1'd0;
	if (csrbank5_sel) begin
		case (interface5_bank_bus_adr[8:0])
			1'd0: begin
				interface5_bank_bus_dat_r <= csrbank5_clk_divisor0_w;
			end
		endcase
	end
	if (csrbank5_clk_divisor0_re) begin
		mgmtsoc_litespisdrphycore_storage[7:0] <= csrbank5_clk_divisor0_r;
	end
	mgmtsoc_litespisdrphycore_re <= csrbank5_clk_divisor0_re;
	...
	if (csrbank6_load0_re) begin
		mgmtsoc_timer_load_storage[31:0] <= csrbank6_load0_r;
	end
	mgmtsoc_timer_load_re <= csrbank6_load0_re;
	if (csrbank6_reload0_re) begin
		mgmtsoc_timer_reload_storage[31:0] <= csrbank6_reload0_r;
	end
	mgmtsoc_timer_reload_re <= csrbank6_reload0_re;
	if (csrbank6_en0_re) begin
		mgmtsoc_timer_en_storage <= csrbank6_en0_r;
	end
	mgmtsoc_timer_en_re <= csrbank6_en0_re;
	if (csrbank6_update_value0_re) begin
		mgmtsoc_timer_update_value_storage <= csrbank6_update_value0_r;
	end
	mgmtsoc_timer_update_value_re <= csrbank6_update_value0_re;
	mgmtsoc_timer_value_re <= csrbank6_value_re;
	mgmtsoc_timer_status_re <= csrbank6_ev_status_re;
	if (csrbank6_ev_pending_re) begin
		mgmtsoc_timer_pending_r <= csrbank6_ev_pending_r;
	end
	mgmtsoc_timer_pending_re <= csrbank6_ev_pending_re;
	if (csrbank6_ev_enable0_re) begin
		mgmtsoc_timer_enable_storage <= csrbank6_ev_enable0_r;
	end
	mgmtsoc_timer_enable_re <= csrbank6_ev_enable0_re;
	interface7_bank_bus_dat_r <= 1'd0;
	if (csrbank7_sel) begin
		case (interface7_bank_bus_adr[8:0])
			1'd0: begin
				interface7_bank_bus_dat_r <= mgmtsoc_uart_rxtx_w;
			end
			1'd1: begin
	...
	mgmtsoc_uart_txfull_re <= csrbank7_txfull_re;
	mgmtsoc_uart_rxempty_re <= csrbank7_rxempty_re;
	mgmtsoc_uart_status_re <= csrbank7_ev_status_re;
	if (csrbank7_ev_pending_re) begin
		mgmtsoc_uart_pending_r[1:0] <= csrbank7_ev_pending_r;
	end
	mgmtsoc_uart_pending_re <= csrbank7_ev_pending_re;
	if (csrbank7_ev_enable0_re) begin
		mgmtsoc_uart_enable_storage[1:0] <= csrbank7_ev_enable0_r;
	end
	mgmtsoc_uart_enable_re <= csrbank7_ev_enable0_re;
	mgmtsoc_uart_txempty_re <= csrbank7_txempty_re;
	mgmtsoc_uart_rxfull_re <= csrbank7_rxfull_re;
	...
	if (csrbank8_out0_re) begin
		user_irq_ena_storage[2:0] <= csrbank8_out0_r;
	end
	user_irq_ena_re <= csrbank8_out0_re;
	if (sys_rst_1) begin
