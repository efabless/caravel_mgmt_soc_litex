//--------------------------------------------------------------------------------
// Auto-generated by Migen (7507a2b) & LiteX (57002cf3) on 2021-11-03 12:40:51
//--------------------------------------------------------------------------------
module top(
	input wire core_clk,
	input wire core_rst,
...
reg [31:0] mgmtsoc_vexriscv = 32'd0;
...
wire [1:0] spi_master_mosi_1;
reg [1:0] spi_master_miso_1 = 2'd0;
wire spi_master_cs;
...
reg [1:0] spi_master_mosi_storage = 2'd0;
reg spi_master_mosi_re = 1'd0;
wire [1:0] spi_master_miso_status;
...
reg [1:0] spi_master_mosi_data = 2'd0;
reg spi_master_mosi_sel = 1'd0;
reg [1:0] spi_master_miso_data = 2'd0;
...
wire mgmtsoc_source_valid;
wire mgmtsoc_source_ready;
wire mgmtsoc_source_first;
wire mgmtsoc_source_last;
wire [31:0] mgmtsoc_source_payload_data;
wire [5:0] mgmtsoc_source_payload_len;
wire [3:0] mgmtsoc_source_payload_width;
wire [7:0] mgmtsoc_source_payload_mask;
wire mgmtsoc_sink_valid;
wire mgmtsoc_sink_ready;
...
wire mgmtsoc_user_port_source_valid;
wire mgmtsoc_user_port_source_ready;
wire mgmtsoc_user_port_source_first;
wire mgmtsoc_user_port_source_last;
wire [31:0] mgmtsoc_user_port_source_payload_data;
wire mgmtsoc_user_port_sink_valid;
wire mgmtsoc_user_port_sink_ready;
wire mgmtsoc_user_port_sink_first;
wire mgmtsoc_user_port_sink_last;
wire [31:0] mgmtsoc_user_port_sink_payload_data;
wire [5:0] mgmtsoc_user_port_sink_payload_len;
wire [3:0] mgmtsoc_user_port_sink_payload_width;
wire [7:0] mgmtsoc_user_port_sink_payload_mask;
wire mgmtsoc_internal_port_source_valid;
wire mgmtsoc_internal_port_source_ready;
wire mgmtsoc_internal_port_source_first;
wire mgmtsoc_internal_port_source_last;
wire [31:0] mgmtsoc_internal_port_source_payload_data;
wire mgmtsoc_internal_port_sink_valid;
wire mgmtsoc_internal_port_sink_ready;
wire mgmtsoc_internal_port_sink_first;
wire mgmtsoc_internal_port_sink_last;
wire [31:0] mgmtsoc_internal_port_sink_payload_data;
wire [5:0] mgmtsoc_internal_port_sink_payload_len;
wire [3:0] mgmtsoc_internal_port_sink_payload_width;
wire [7:0] mgmtsoc_internal_port_sink_payload_mask;
wire mgmtsoc_request;
...
reg spi_master_count_spimaster_next_value = 1'd0;
...
reg obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value1 = 1'd0;
reg obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value_ce1 = 1'd0;
...
wire [1:0] csrbank4_mosi0_r;
reg csrbank4_mosi0_we = 1'd0;
wire [1:0] csrbank4_mosi0_w;
reg csrbank4_miso_re = 1'd0;
wire [1:0] csrbank4_miso_r;
reg csrbank4_miso_we = 1'd0;
wire [1:0] csrbank4_miso_w;
...
wire [2:0] csrbank9_out0_r;
reg csrbank9_out0_we = 1'd0;
wire [2:0] csrbank9_out0_w;
wire csrbank9_sel;
...
assign mgmtsoc_litespisdrphycore_cs = mgmtsoc_cs;
assign mgmtsoc_litespimmap_sink_valid = mgmtsoc_user_port_source_valid;
assign mgmtsoc_user_port_source_ready = mgmtsoc_litespimmap_sink_ready;
assign mgmtsoc_litespimmap_sink_first = mgmtsoc_user_port_source_first;
assign mgmtsoc_litespimmap_sink_last = mgmtsoc_user_port_source_last;
assign mgmtsoc_litespimmap_sink_payload_data = mgmtsoc_user_port_source_payload_data;
assign mgmtsoc_user_port_sink_valid = mgmtsoc_litespimmap_source_valid;
assign mgmtsoc_litespimmap_source_ready = mgmtsoc_user_port_sink_ready;
assign mgmtsoc_user_port_sink_first = mgmtsoc_litespimmap_source_first;
assign mgmtsoc_user_port_sink_last = mgmtsoc_litespimmap_source_last;
assign mgmtsoc_user_port_sink_payload_data = mgmtsoc_litespimmap_source_payload_data;
assign mgmtsoc_user_port_sink_payload_len = mgmtsoc_litespimmap_source_payload_len;
assign mgmtsoc_user_port_sink_payload_width = mgmtsoc_litespimmap_source_payload_width;
assign mgmtsoc_user_port_sink_payload_mask = mgmtsoc_litespimmap_source_payload_mask;
assign mgmtsoc_litespisdrphycore_sink_valid = mgmtsoc_source_valid;
assign mgmtsoc_source_ready = mgmtsoc_litespisdrphycore_sink_ready;
assign mgmtsoc_litespisdrphycore_sink_first = mgmtsoc_source_first;
assign mgmtsoc_litespisdrphycore_sink_last = mgmtsoc_source_last;
assign mgmtsoc_litespisdrphycore_sink_payload_data = mgmtsoc_source_payload_data;
assign mgmtsoc_litespisdrphycore_sink_payload_len = mgmtsoc_source_payload_len;
assign mgmtsoc_litespisdrphycore_sink_payload_width = mgmtsoc_source_payload_width;
assign mgmtsoc_litespisdrphycore_sink_payload_mask = mgmtsoc_source_payload_mask;
assign mgmtsoc_sink_valid = mgmtsoc_litespisdrphycore_source_valid;
assign mgmtsoc_litespisdrphycore_source_ready = mgmtsoc_sink_ready;
assign mgmtsoc_sink_first = mgmtsoc_litespisdrphycore_source_first;
assign mgmtsoc_sink_last = mgmtsoc_litespisdrphycore_source_last;
assign mgmtsoc_sink_payload_data = mgmtsoc_litespisdrphycore_source_payload_data;
assign mgmtsoc_internal_port_sink_valid = mgmtsoc_user_port_sink_valid;
assign mgmtsoc_user_port_sink_ready = mgmtsoc_internal_port_sink_ready;
assign mgmtsoc_internal_port_sink_first = mgmtsoc_user_port_sink_first;
assign mgmtsoc_internal_port_sink_last = mgmtsoc_user_port_sink_last;
assign mgmtsoc_internal_port_sink_payload_data = mgmtsoc_user_port_sink_payload_data;
assign mgmtsoc_internal_port_sink_payload_len = mgmtsoc_user_port_sink_payload_len;
assign mgmtsoc_internal_port_sink_payload_width = mgmtsoc_user_port_sink_payload_width;
assign mgmtsoc_internal_port_sink_payload_mask = mgmtsoc_user_port_sink_payload_mask;
assign mgmtsoc_user_port_source_valid = mgmtsoc_internal_port_source_valid;
assign mgmtsoc_internal_port_source_ready = mgmtsoc_user_port_source_ready;
assign mgmtsoc_user_port_source_first = mgmtsoc_internal_port_source_first;
assign mgmtsoc_user_port_source_last = mgmtsoc_internal_port_source_last;
assign mgmtsoc_user_port_source_payload_data = mgmtsoc_internal_port_source_payload_data;
assign mgmtsoc_request = mgmtsoc_litespimmap_cs;
assign litespi_tx_mux_sink_valid = mgmtsoc_internal_port_sink_valid;
assign mgmtsoc_internal_port_sink_ready = litespi_tx_mux_sink_ready;
assign litespi_tx_mux_sink_first = mgmtsoc_internal_port_sink_first;
assign litespi_tx_mux_sink_last = mgmtsoc_internal_port_sink_last;
assign litespi_tx_mux_sink_payload_data = mgmtsoc_internal_port_sink_payload_data;
assign litespi_tx_mux_sink_payload_len = mgmtsoc_internal_port_sink_payload_len;
assign litespi_tx_mux_sink_payload_width = mgmtsoc_internal_port_sink_payload_width;
assign litespi_tx_mux_sink_payload_mask = mgmtsoc_internal_port_sink_payload_mask;
assign mgmtsoc_internal_port_source_valid = litespi_rx_demux_source_valid;
assign litespi_rx_demux_source_ready = mgmtsoc_internal_port_source_ready;
assign mgmtsoc_internal_port_source_first = litespi_rx_demux_source_first;
assign mgmtsoc_internal_port_source_last = litespi_rx_demux_source_last;
assign mgmtsoc_internal_port_source_payload_data = litespi_rx_demux_source_payload_data;
assign litespi_request = {mgmtsoc_request};
assign mgmtsoc_source_valid = litespi_tx_mux_source_valid;
assign litespi_tx_mux_source_ready = mgmtsoc_source_ready;
assign mgmtsoc_source_first = litespi_tx_mux_source_first;
assign mgmtsoc_source_last = litespi_tx_mux_source_last;
assign mgmtsoc_source_payload_data = litespi_tx_mux_source_payload_data;
assign mgmtsoc_source_payload_len = litespi_tx_mux_source_payload_len;
assign mgmtsoc_source_payload_width = litespi_tx_mux_source_payload_width;
assign mgmtsoc_source_payload_mask = litespi_tx_mux_source_payload_mask;
assign litespi_tx_mux_sel = litespi_grant;
assign litespi_rx_demux_sink_valid = mgmtsoc_sink_valid;
assign mgmtsoc_sink_ready = litespi_rx_demux_sink_ready;
assign litespi_rx_demux_sink_first = mgmtsoc_sink_first;
assign litespi_rx_demux_sink_last = mgmtsoc_sink_last;
assign litespi_rx_demux_sink_payload_data = mgmtsoc_sink_payload_data;
assign litespi_rx_demux_sel = litespi_grant;
always @(*) begin
	mgmtsoc_cs <= 1'd0;
	case (litespi_grant)
		1'd0: begin
			mgmtsoc_cs <= mgmtsoc_litespimmap_cs;
		end
	endcase
end
...
always @(*) begin
	...
	obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value1 <= 1'd0;
	obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value_ce1 <= 1'd0;
	...
	case (uartwishbonebridge_rs232phytx_state)
		1'd1: begin
			...
			if (uart_bridge_tx_tick) begin
				obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value1 <= uart_bridge_tx_data;
				obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value_ce1 <= 1'd1;
		...
		default: begin
			...
			uart_bridge_tx_count_uartwishbonebridge_rs232phytx_next_value_ce0 <= 1'd1;
			obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value1 <= 1'd1;
			obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value_ce1 <= 1'd1;
...
assign uart_bridge_wishbone_ack = (shared_ack & (grant == 2'd2));
assign mgmtsoc_ibus_ibus_err = (shared_err & (grant == 1'd0));
assign mgmtsoc_dbus_dbus_err = (shared_err & (grant == 1'd1));
assign uart_bridge_wishbone_err = (shared_err & (grant == 2'd2));
assign request = {uart_bridge_wishbone_cyc, mgmtsoc_dbus_dbus_cyc, mgmtsoc_ibus_ibus_cyc};
always @(*) begin
	slave_sel <= 3'd0;
...
assign shared_err = ((mgmtsoc_vexriscv_debug_bus_err | mgmtsoc_litespimmap_bus_err) | mgmtsoc_wishbone_err);
assign wait_1 = ((shared_stb & shared_cyc) & (~shared_ack));
always @(*) begin
	error <= 1'd0;
	shared_ack <= 1'd0;
	shared_dat_r <= 32'd0;
	shared_ack <= ((mgmtsoc_vexriscv_debug_bus_ack | mgmtsoc_litespimmap_bus_ack) | mgmtsoc_wishbone_ack);
	shared_dat_r <= ((({32{slave_sel_r[0]}} & mgmtsoc_vexriscv_debug_bus_dat_r) | ({32{slave_sel_r[1]}} & mgmtsoc_litespimmap_bus_dat_r)) | ({32{slave_sel_r[2]}} & mgmtsoc_wishbone_dat_r));
	if (done) begin
...
assign csrbank4_mosi0_r = interface4_bank_bus_dat_w[1:0];
always @(*) begin
...
assign csrbank4_miso_r = interface4_bank_bus_dat_w[1:0];
always @(*) begin
...
assign csrbank4_mosi0_w = spi_master_mosi_storage[1:0];
assign csrbank4_miso_w = spi_master_miso_status[1:0];
...
assign csrbank9_out0_r = interface9_bank_bus_dat_w[2:0];
always @(*) begin
...
assign csrbank9_out0_w = user_irq_ena_storage[2:0];
...
always @(posedge sys_clk) begin
	...
	if (obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value_ce1) begin
		serial_dbg_tx <= obj_serial_dbg_tx_uartwishbonebridge_rs232phytx_next_value1;
	end
	...
	if (csrbank4_mosi0_re) begin
		spi_master_mosi_storage[1:0] <= csrbank4_mosi0_r;
	end
	...
	if (csrbank9_out0_re) begin
		user_irq_ena_storage[2:0] <= csrbank9_out0_r;
	end
	user_irq_ena_re <= csrbank9_out0_re;
	if (sys_rst) begin
		...
		spi_master_count <= 1'd0;
		spi_master_clk_divider1 <= 16'd0;
		spi_master_mosi_data <= 2'd0;
		spi_master_mosi_sel <= 1'd0;
		spi_master_miso_data <= 2'd0;
