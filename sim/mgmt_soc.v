...
always @(*) begin
	interrupt = 32'd0;
	interrupt[0] = gpioin0_gpioin0_irq;
	interrupt[1] = gpioin1_gpioin1_irq;
	interrupt[2] = gpioin2_gpioin2_irq;
	interrupt[3] = gpioin3_gpioin3_irq;
	interrupt[4] = gpioin4_gpioin4_irq;
	interrupt[5] = gpioin5_gpioin5_irq;
end
...
always @(*) begin
	slave_sel = 3'd0;
	slave_sel[0] = (shared_adr[29:9] == 18'd131072);
