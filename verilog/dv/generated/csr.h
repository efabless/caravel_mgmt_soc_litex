//--------------------------------------------------------------------------------
// Auto-generated by Migen (9a0be7a) & LiteX (ae50207) on 2021-11-24 18:05:42
//--------------------------------------------------------------------------------
...
/* qspi_enabled */
#define CSR_QSPI_ENABLED_BASE (CSR_BASE + 0x4000L)
#define CSR_QSPI_ENABLED_OUT_ADDR (CSR_BASE + 0x4000L)
...
/* spi_enabled */
#define CSR_SPI_ENABLED_BASE (CSR_BASE + 0x4800L)
#define CSR_SPI_ENABLED_OUT_ADDR (CSR_BASE + 0x4800L)
...
/* spi_master */
#define CSR_SPI_MASTER_BASE (CSR_BASE + 0x5000L)
#define CSR_SPI_MASTER_CONTROL_ADDR (CSR_BASE + 0x5000L)
...
#define CSR_SPI_MASTER_STATUS_ADDR (CSR_BASE + 0x5004L)
...
#define CSR_SPI_MASTER_MOSI_ADDR (CSR_BASE + 0x5008L)
...
#define CSR_SPI_MASTER_LOOPBACK_ADDR (CSR_BASE + 0x5014L)
...
#define CSR_SPI_MASTER_CLK_DIVIDER_ADDR (CSR_BASE + 0x5018L)
...
/* uart_enabled */
#define CSR_UART_ENABLED_BASE (CSR_BASE + 0x6800L)
#define CSR_UART_ENABLED_OUT_ADDR (CSR_BASE + 0x6800L)
...
/* user_irq_0 */
#define CSR_USER_IRQ_0_BASE (CSR_BASE + 0x7000L)
#define CSR_USER_IRQ_0_IN_ADDR (CSR_BASE + 0x7000L)
#define CSR_USER_IRQ_0_IN_SIZE 1
static inline uint32_t user_irq_0_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x7000L);
}
#define CSR_USER_IRQ_0_MODE_ADDR (CSR_BASE + 0x7004L)
...
#define CSR_USER_IRQ_0_EDGE_ADDR (CSR_BASE + 0x7008L)
...
#define CSR_USER_IRQ_0_EV_STATUS_ADDR (CSR_BASE + 0x700cL)
...
#define CSR_USER_IRQ_0_EV_PENDING_ADDR (CSR_BASE + 0x7010L)
...
#define CSR_USER_IRQ_0_EV_ENABLE_ADDR (CSR_BASE + 0x7014L)
...
/* user_irq_1 */
#define CSR_USER_IRQ_1_BASE (CSR_BASE + 0x7800L)
#define CSR_USER_IRQ_1_IN_ADDR (CSR_BASE + 0x7800L)
#define CSR_USER_IRQ_1_IN_SIZE 1
static inline uint32_t user_irq_1_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x7800L);
}
#define CSR_USER_IRQ_1_MODE_ADDR (CSR_BASE + 0x7804L)
...
#define CSR_USER_IRQ_1_EDGE_ADDR (CSR_BASE + 0x7808L)
...
#define CSR_USER_IRQ_1_EV_STATUS_ADDR (CSR_BASE + 0x780cL)
...
#define CSR_USER_IRQ_1_EV_PENDING_ADDR (CSR_BASE + 0x7810L)
...
#define CSR_USER_IRQ_1_EV_ENABLE_ADDR (CSR_BASE + 0x7814L)
...
/* user_irq_2 */
#define CSR_USER_IRQ_2_BASE (CSR_BASE + 0x8000L)
#define CSR_USER_IRQ_2_IN_ADDR (CSR_BASE + 0x8000L)
#define CSR_USER_IRQ_2_IN_SIZE 1
static inline uint32_t user_irq_2_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x8000L);
}
#define CSR_USER_IRQ_2_MODE_ADDR (CSR_BASE + 0x8004L)
...
#define CSR_USER_IRQ_2_EDGE_ADDR (CSR_BASE + 0x8008L)
...
#define CSR_USER_IRQ_2_EV_STATUS_ADDR (CSR_BASE + 0x800cL)
...
#define CSR_USER_IRQ_2_EV_PENDING_ADDR (CSR_BASE + 0x8010L)
...
#define CSR_USER_IRQ_2_EV_ENABLE_ADDR (CSR_BASE + 0x8014L)
...
/* user_irq_3 */
#define CSR_USER_IRQ_3_BASE (CSR_BASE + 0x8800L)
#define CSR_USER_IRQ_3_IN_ADDR (CSR_BASE + 0x8800L)
#define CSR_USER_IRQ_3_IN_SIZE 1
static inline uint32_t user_irq_3_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x8800L);
}
#define CSR_USER_IRQ_3_MODE_ADDR (CSR_BASE + 0x8804L)
...
#define CSR_USER_IRQ_3_EDGE_ADDR (CSR_BASE + 0x8808L)
...
#define CSR_USER_IRQ_3_EV_STATUS_ADDR (CSR_BASE + 0x880cL)
...
#define CSR_USER_IRQ_3_EV_PENDING_ADDR (CSR_BASE + 0x8810L)
...
#define CSR_USER_IRQ_3_EV_ENABLE_ADDR (CSR_BASE + 0x8814L)
...
/* user_irq_4 */
#define CSR_USER_IRQ_4_BASE (CSR_BASE + 0x9000L)
#define CSR_USER_IRQ_4_IN_ADDR (CSR_BASE + 0x9000L)
#define CSR_USER_IRQ_4_IN_SIZE 1
static inline uint32_t user_irq_4_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x9000L);
}
#define CSR_USER_IRQ_4_MODE_ADDR (CSR_BASE + 0x9004L)
...
#define CSR_USER_IRQ_4_EDGE_ADDR (CSR_BASE + 0x9008L)
...
#define CSR_USER_IRQ_4_EV_STATUS_ADDR (CSR_BASE + 0x900cL)
...
#define CSR_USER_IRQ_4_EV_PENDING_ADDR (CSR_BASE + 0x9010L)
...
#define CSR_USER_IRQ_4_EV_ENABLE_ADDR (CSR_BASE + 0x9014L)
...
/* user_irq_5 */
#define CSR_USER_IRQ_5_BASE (CSR_BASE + 0x9800L)
#define CSR_USER_IRQ_5_IN_ADDR (CSR_BASE + 0x9800L)
#define CSR_USER_IRQ_5_IN_SIZE 1
static inline uint32_t user_irq_5_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x9800L);
}
#define CSR_USER_IRQ_5_MODE_ADDR (CSR_BASE + 0x9804L)
...
#define CSR_USER_IRQ_5_EDGE_ADDR (CSR_BASE + 0x9808L)
...
#define CSR_USER_IRQ_5_EV_STATUS_ADDR (CSR_BASE + 0x980cL)
...
#define CSR_USER_IRQ_5_EV_PENDING_ADDR (CSR_BASE + 0x9810L)
...
#define CSR_USER_IRQ_5_EV_ENABLE_ADDR (CSR_BASE + 0x9814L)
...
/* user_irq_ena */
#define CSR_USER_IRQ_ENA_BASE (CSR_BASE + 0xa000L)
#define CSR_USER_IRQ_ENA_OUT_ADDR (CSR_BASE + 0xa000L)
