...
/* flash_core */
#define CSR_FLASH_CORE_BASE (CSR_BASE + 0x1000L)
#define CSR_FLASH_CORE_MMAP_DUMMY_BITS_ADDR (CSR_BASE + 0x1000L)
...
#define CSR_FLASH_CORE_MASTER_CS_ADDR (CSR_BASE + 0x1004L)
...
#define CSR_FLASH_CORE_MASTER_PHYCONFIG_ADDR (CSR_BASE + 0x1008L)
...
#define CSR_FLASH_CORE_MASTER_RXTX_ADDR (CSR_BASE + 0x100cL)
...
#define CSR_FLASH_CORE_MASTER_STATUS_ADDR (CSR_BASE + 0x1010L)
...
/* flash_io2_oenb_state */
#define CSR_FLASH_IO2_OENB_STATE_BASE (CSR_BASE + 0x1800L)
#define CSR_FLASH_IO2_OENB_STATE_OUT_ADDR (CSR_BASE + 0x1800L)
#define CSR_FLASH_IO2_OENB_STATE_OUT_SIZE 1
static inline uint32_t flash_io2_oenb_state_out_read(void) {
	return csr_read_simple(CSR_BASE + 0x1800L);
}
static inline void flash_io2_oenb_state_out_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x1800L);
}

/* flash_io3_oenb_state */
#define CSR_FLASH_IO3_OENB_STATE_BASE (CSR_BASE + 0x2000L)
#define CSR_FLASH_IO3_OENB_STATE_OUT_ADDR (CSR_BASE + 0x2000L)
#define CSR_FLASH_IO3_OENB_STATE_OUT_SIZE 1
static inline uint32_t flash_io3_oenb_state_out_read(void) {
	return csr_read_simple(CSR_BASE + 0x2000L);
}
static inline void flash_io3_oenb_state_out_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x2000L);
}

/* flash_phy */
#define CSR_FLASH_PHY_BASE (CSR_BASE + 0x2800L)
#define CSR_FLASH_PHY_CLK_DIVISOR_ADDR (CSR_BASE + 0x2800L)
...
#define CSR_GPIO_MODE1_ADDR (CSR_BASE + 0x3000L)
...
#define CSR_GPIO_MODE0_ADDR (CSR_BASE + 0x3004L)
...
#define CSR_GPIO_IEN_ADDR (CSR_BASE + 0x3008L)
...
#define CSR_GPIO_OE_ADDR (CSR_BASE + 0x300cL)
...
/* jtag_oenb_state */
#define CSR_JTAG_OENB_STATE_BASE (CSR_BASE + 0x3800L)
#define CSR_JTAG_OENB_STATE_OUT_ADDR (CSR_BASE + 0x3800L)
#define CSR_JTAG_OENB_STATE_OUT_SIZE 1
static inline uint32_t jtag_oenb_state_out_read(void) {
	return csr_read_simple(CSR_BASE + 0x3800L);
}
static inline void jtag_oenb_state_out_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x3800L);
}

/* la */
#define CSR_LA_BASE (CSR_BASE + 0x4000L)
#define CSR_LA_IEN_ADDR (CSR_BASE + 0x4000L)
#define CSR_LA_IEN_SIZE 4
#define CSR_LA_OE_ADDR (CSR_BASE + 0x4010L)
#define CSR_LA_OE_SIZE 4
#define CSR_LA_IN_ADDR (CSR_BASE + 0x4020L)
#define CSR_LA_IN_SIZE 4
#define CSR_LA_OUT_ADDR (CSR_BASE + 0x4030L)
#define CSR_LA_OUT_SIZE 4

/* mprj_wb_iena */
#define CSR_MPRJ_WB_IENA_BASE (CSR_BASE + 0x4800L)
#define CSR_MPRJ_WB_IENA_OUT_ADDR (CSR_BASE + 0x4800L)
...
/* qspi_enabled */
#define CSR_QSPI_ENABLED_BASE (CSR_BASE + 0x5000L)
#define CSR_QSPI_ENABLED_OUT_ADDR (CSR_BASE + 0x5000L)
#define CSR_QSPI_ENABLED_OUT_SIZE 1
static inline uint32_t qspi_enabled_out_read(void) {
	return csr_read_simple(CSR_BASE + 0x5000L);
}
static inline void qspi_enabled_out_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x5000L);
}

/* sdo_oenb_state */
#define CSR_SDO_OENB_STATE_BASE (CSR_BASE + 0x5800L)
#define CSR_SDO_OENB_STATE_OUT_ADDR (CSR_BASE + 0x5800L)
#define CSR_SDO_OENB_STATE_OUT_SIZE 1
static inline uint32_t sdo_oenb_state_out_read(void) {
	return csr_read_simple(CSR_BASE + 0x5800L);
}
static inline void sdo_oenb_state_out_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x5800L);
}

/* spi_enabled */
#define CSR_SPI_ENABLED_BASE (CSR_BASE + 0x6000L)
#define CSR_SPI_ENABLED_OUT_ADDR (CSR_BASE + 0x6000L)
...
/* spi_master */
#define CSR_SPI_MASTER_BASE (CSR_BASE + 0x6800L)
#define CSR_SPI_MASTER_CONTROL_ADDR (CSR_BASE + 0x6800L)
...
#define CSR_SPI_MASTER_STATUS_ADDR (CSR_BASE + 0x6804L)
...
#define CSR_SPI_MASTER_MOSI_ADDR (CSR_BASE + 0x6808L)
...
#define CSR_SPI_MASTER_LOOPBACK_ADDR (CSR_BASE + 0x6814L)
...
#define CSR_SPI_MASTER_CLK_DIVIDER_ADDR (CSR_BASE + 0x6818L)
...
/* uart_enabled */
#define CSR_UART_ENABLED_BASE (CSR_BASE + 0x7000L)
#define CSR_UART_ENABLED_OUT_ADDR (CSR_BASE + 0x7000L)
...
/* user_irq_0 */
#define CSR_USER_IRQ_0_BASE (CSR_BASE + 0x7800L)
#define CSR_USER_IRQ_0_IN_ADDR (CSR_BASE + 0x7800L)
#define CSR_USER_IRQ_0_IN_SIZE 1
static inline uint32_t user_irq_0_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x7800L);
}
#define CSR_USER_IRQ_0_MODE_ADDR (CSR_BASE + 0x7804L)
...
#define CSR_USER_IRQ_0_EDGE_ADDR (CSR_BASE + 0x7808L)
...
#define CSR_USER_IRQ_0_EV_STATUS_ADDR (CSR_BASE + 0x780cL)
...
#define CSR_USER_IRQ_0_EV_PENDING_ADDR (CSR_BASE + 0x7810L)
...
#define CSR_USER_IRQ_0_EV_ENABLE_ADDR (CSR_BASE + 0x7814L)
...
/* user_irq_1 */
#define CSR_USER_IRQ_1_BASE (CSR_BASE + 0x8000L)
#define CSR_USER_IRQ_1_IN_ADDR (CSR_BASE + 0x8000L)
#define CSR_USER_IRQ_1_IN_SIZE 1
static inline uint32_t user_irq_1_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x8000L);
}
#define CSR_USER_IRQ_1_MODE_ADDR (CSR_BASE + 0x8004L)
...
#define CSR_USER_IRQ_1_EDGE_ADDR (CSR_BASE + 0x8008L)
...
#define CSR_USER_IRQ_1_EV_STATUS_ADDR (CSR_BASE + 0x800cL)
...
#define CSR_USER_IRQ_1_EV_PENDING_ADDR (CSR_BASE + 0x8010L)
...
#define CSR_USER_IRQ_1_EV_ENABLE_ADDR (CSR_BASE + 0x8014L)
...
/* user_irq_2 */
#define CSR_USER_IRQ_2_BASE (CSR_BASE + 0x8800L)
#define CSR_USER_IRQ_2_IN_ADDR (CSR_BASE + 0x8800L)
#define CSR_USER_IRQ_2_IN_SIZE 1
static inline uint32_t user_irq_2_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x8800L);
}
#define CSR_USER_IRQ_2_MODE_ADDR (CSR_BASE + 0x8804L)
...
#define CSR_USER_IRQ_2_EDGE_ADDR (CSR_BASE + 0x8808L)
...
#define CSR_USER_IRQ_2_EV_STATUS_ADDR (CSR_BASE + 0x880cL)
...
#define CSR_USER_IRQ_2_EV_PENDING_ADDR (CSR_BASE + 0x8810L)
...
#define CSR_USER_IRQ_2_EV_ENABLE_ADDR (CSR_BASE + 0x8814L)
...
/* user_irq_3 */
#define CSR_USER_IRQ_3_BASE (CSR_BASE + 0x9000L)
#define CSR_USER_IRQ_3_IN_ADDR (CSR_BASE + 0x9000L)
#define CSR_USER_IRQ_3_IN_SIZE 1
static inline uint32_t user_irq_3_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x9000L);
}
#define CSR_USER_IRQ_3_MODE_ADDR (CSR_BASE + 0x9004L)
...
#define CSR_USER_IRQ_3_EDGE_ADDR (CSR_BASE + 0x9008L)
...
#define CSR_USER_IRQ_3_EV_STATUS_ADDR (CSR_BASE + 0x900cL)
...
#define CSR_USER_IRQ_3_EV_PENDING_ADDR (CSR_BASE + 0x9010L)
...
#define CSR_USER_IRQ_3_EV_ENABLE_ADDR (CSR_BASE + 0x9014L)
...
/* user_irq_4 */
#define CSR_USER_IRQ_4_BASE (CSR_BASE + 0x9800L)
#define CSR_USER_IRQ_4_IN_ADDR (CSR_BASE + 0x9800L)
#define CSR_USER_IRQ_4_IN_SIZE 1
static inline uint32_t user_irq_4_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x9800L);
}
#define CSR_USER_IRQ_4_MODE_ADDR (CSR_BASE + 0x9804L)
...
static inline void user_irq_4_mode_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x9804L);
}
#define CSR_USER_IRQ_4_EDGE_ADDR (CSR_BASE + 0x9808L)
...
#define CSR_USER_IRQ_4_EV_STATUS_ADDR (CSR_BASE + 0x980cL)
...
#define CSR_USER_IRQ_4_EV_PENDING_ADDR (CSR_BASE + 0x9810L)
...
#define CSR_USER_IRQ_4_EV_ENABLE_ADDR (CSR_BASE + 0x9814L)
...
/* user_irq_5 */
#define CSR_USER_IRQ_5_BASE (CSR_BASE + 0xa000L)
#define CSR_USER_IRQ_5_IN_ADDR (CSR_BASE + 0xa000L)
#define CSR_USER_IRQ_5_IN_SIZE 1
static inline uint32_t user_irq_5_in_read(void) {
	return csr_read_simple(CSR_BASE + 0xa000L);
}
#define CSR_USER_IRQ_5_MODE_ADDR (CSR_BASE + 0xa004L)
...
#define CSR_USER_IRQ_5_EDGE_ADDR (CSR_BASE + 0xa008L)
...
#define CSR_USER_IRQ_5_EV_STATUS_ADDR (CSR_BASE + 0xa00cL)
...
#define CSR_USER_IRQ_5_EV_PENDING_ADDR (CSR_BASE + 0xa010L)
...
#define CSR_USER_IRQ_5_EV_ENABLE_ADDR (CSR_BASE + 0xa014L)
...
/* user_irq_ena */
#define CSR_USER_IRQ_ENA_BASE (CSR_BASE + 0xa800L)
#define CSR_USER_IRQ_ENA_OUT_ADDR (CSR_BASE + 0xa800L)
