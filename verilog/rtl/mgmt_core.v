...
assign csrbank10_load0_w = mgmtsoc_timer_load_storage[31:0];
assign csrbank10_reload0_w = mgmtsoc_timer_reload_storage[31:0];
assign csrbank10_en0_w = mgmtsoc_timer_en_storage;
assign csrbank10_update_value0_w = mgmtsoc_timer_update_value_storage;
assign csrbank10_value_w = mgmtsoc_timer_value_status[31:0];
assign mgmtsoc_timer_value_we = csrbank10_value_we;
assign mgmtsoc_timer_status_status = mgmtsoc_timer_zero0;
assign csrbank10_ev_status_w = mgmtsoc_timer_status_status;
assign mgmtsoc_timer_status_we = csrbank10_ev_status_we;
assign mgmtsoc_timer_pending_status = mgmtsoc_timer_zero1;
assign csrbank10_ev_pending_w = mgmtsoc_timer_pending_status;
assign mgmtsoc_timer_pending_we = csrbank10_ev_pending_we;
assign mgmtsoc_timer_zero2 = mgmtsoc_timer_enable_storage;
assign csrbank10_ev_enable0_w = mgmtsoc_timer_enable_storage;
assign csrbank11_sel = (interface11_bank_bus_adr[13:9] == 4'd11);
assign mgmtsoc_uart_rxtx_r = interface11_bank_bus_dat_w[7:0];
always @(*) begin
	mgmtsoc_uart_rxtx_we = 1'd0;
	if ((csrbank11_sel & (interface11_bank_bus_adr[8:0] == 1'd0))) begin
		mgmtsoc_uart_rxtx_we = (~interface11_bank_bus_we);
	end
end
always @(*) begin
	mgmtsoc_uart_rxtx_re = 1'd0;
	if ((csrbank11_sel & (interface11_bank_bus_adr[8:0] == 1'd0))) begin
		mgmtsoc_uart_rxtx_re = interface11_bank_bus_we;
	end
end
...
assign csrbank11_txfull_w = mgmtsoc_uart_txfull_status;
assign mgmtsoc_uart_txfull_we = csrbank11_txfull_we;
assign csrbank11_rxempty_w = mgmtsoc_uart_rxempty_status;
assign mgmtsoc_uart_rxempty_we = csrbank11_rxempty_we;
always @(*) begin
...
assign csrbank11_ev_status_w = mgmtsoc_uart_status_status[1:0];
assign mgmtsoc_uart_status_we = csrbank11_ev_status_we;
always @(*) begin
...
assign csrbank11_ev_pending_w = mgmtsoc_uart_pending_status[1:0];
assign mgmtsoc_uart_pending_we = csrbank11_ev_pending_we;
assign mgmtsoc_uart_tx2 = mgmtsoc_uart_enable_storage[0];
assign mgmtsoc_uart_rx2 = mgmtsoc_uart_enable_storage[1];
assign csrbank11_ev_enable0_w = mgmtsoc_uart_enable_storage[1:0];
assign csrbank11_txempty_w = mgmtsoc_uart_txempty_status;
assign mgmtsoc_uart_txempty_we = csrbank11_txempty_we;
assign csrbank11_rxfull_w = mgmtsoc_uart_rxfull_status;
assign mgmtsoc_uart_rxfull_we = csrbank11_rxfull_we;
...
always @(posedge sys_clk) begin
	...
	if (csrbank10_load0_re) begin
		mgmtsoc_timer_load_storage[31:0] <= csrbank10_load0_r;
	end
	mgmtsoc_timer_load_re <= csrbank10_load0_re;
	if (csrbank10_reload0_re) begin
		mgmtsoc_timer_reload_storage[31:0] <= csrbank10_reload0_r;
	end
	mgmtsoc_timer_reload_re <= csrbank10_reload0_re;
	if (csrbank10_en0_re) begin
		mgmtsoc_timer_en_storage <= csrbank10_en0_r;
	end
	mgmtsoc_timer_en_re <= csrbank10_en0_re;
	if (csrbank10_update_value0_re) begin
		mgmtsoc_timer_update_value_storage <= csrbank10_update_value0_r;
	end
	mgmtsoc_timer_update_value_re <= csrbank10_update_value0_re;
	mgmtsoc_timer_value_re <= csrbank10_value_re;
	mgmtsoc_timer_status_re <= csrbank10_ev_status_re;
	if (csrbank10_ev_pending_re) begin
		mgmtsoc_timer_pending_r <= csrbank10_ev_pending_r;
	end
	mgmtsoc_timer_pending_re <= csrbank10_ev_pending_re;
	if (csrbank10_ev_enable0_re) begin
		mgmtsoc_timer_enable_storage <= csrbank10_ev_enable0_r;
	end
	mgmtsoc_timer_enable_re <= csrbank10_ev_enable0_re;
	interface11_bank_bus_dat_r <= 1'd0;
	if (csrbank11_sel) begin
		case (interface11_bank_bus_adr[8:0])
			1'd0: begin
				interface11_bank_bus_dat_r <= mgmtsoc_uart_rxtx_w;
			end
			1'd1: begin
	...
	mgmtsoc_uart_txfull_re <= csrbank11_txfull_re;
	mgmtsoc_uart_rxempty_re <= csrbank11_rxempty_re;
	mgmtsoc_uart_status_re <= csrbank11_ev_status_re;
	if (csrbank11_ev_pending_re) begin
		mgmtsoc_uart_pending_r[1:0] <= csrbank11_ev_pending_r;
	end
	mgmtsoc_uart_pending_re <= csrbank11_ev_pending_re;
	if (csrbank11_ev_enable0_re) begin
		mgmtsoc_uart_enable_storage[1:0] <= csrbank11_ev_enable0_r;
	end
	mgmtsoc_uart_enable_re <= csrbank11_ev_enable0_re;
	mgmtsoc_uart_txempty_re <= csrbank11_txempty_re;
	mgmtsoc_uart_rxfull_re <= csrbank11_rxfull_re;
