...
always @(*) begin
	...
	builder_slave_sel[2] = (builder_shared_adr[29:18] == 10'd768);
	builder_slave_sel[3] = (builder_shared_adr[29:18] == 10'd608);
...
assign main_mprj_cyc = (builder_shared_cyc & builder_slave_sel[2]);
assign main_hk_cyc = (builder_shared_cyc & builder_slave_sel[3]);
assign builder_mgmtsoc_wishbone_cyc = (builder_shared_cyc & builder_slave_sel[4]);
always @(*) begin
	builder_shared_ack = 1'd0;
	builder_shared_ack = ((((main_bus_ack | main_litespimmap_bus_ack) | main_mprj_ack) | main_hk_ack) | builder_mgmtsoc_wishbone_ack);
	if (builder_done) begin
		builder_shared_ack = 1'd1;
	end
end
assign builder_shared_err = ((((main_bus_err | main_litespimmap_bus_err) | main_mprj_err) | main_hk_err) | builder_mgmtsoc_wishbone_err);
always @(*) begin
	builder_shared_dat_r = 32'd0;
	builder_shared_dat_r = ((((({32{builder_slave_sel_r[0]}} & main_bus_dat_r) | ({32{builder_slave_sel_r[1]}} & main_litespimmap_bus_dat_r)) | ({32{builder_slave_sel_r[2]}} & main_mprj_dat_r)) | ({32{builder_slave_sel_r[3]}} & main_hk_dat_r)) | ({32{builder_slave_sel_r[4]}} & builder_mgmtsoc_wishbone_dat_r));
	if (builder_done) begin
...
always @(posedge sys_clk) begin
	...
	builder_multiregimpl0_regs0 <= debug_rx;
