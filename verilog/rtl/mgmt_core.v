//--------------------------------------------------------------------------------
// Auto-generated by Migen (9a0be7a) & LiteX (065e0b9) on 2021-11-17 07:17:07
//--------------------------------------------------------------------------------
module mgmt_core(
...
wire mgmtsoc_ibex_reset;
reg [29:0] mgmtsoc_ibex_interface_ibus_adr = 30'd0;
reg [31:0] mgmtsoc_ibex_interface_ibus_dat_w = 32'd0;
wire [31:0] mgmtsoc_ibex_interface_ibus_dat_r;
reg [3:0] mgmtsoc_ibex_interface_ibus_sel = 4'd0;
reg mgmtsoc_ibex_interface_ibus_cyc = 1'd0;
reg mgmtsoc_ibex_interface_ibus_stb = 1'd0;
wire mgmtsoc_ibex_interface_ibus_ack;
reg mgmtsoc_ibex_interface_ibus_we = 1'd0;
reg [2:0] mgmtsoc_ibex_interface_ibus_cti = 3'd0;
reg [1:0] mgmtsoc_ibex_interface_ibus_bte = 2'd0;
wire mgmtsoc_ibex_interface_ibus_err;
reg [29:0] mgmtsoc_ibex_interface_dbus_adr = 30'd0;
reg [31:0] mgmtsoc_ibex_interface_dbus_dat_w = 32'd0;
wire [31:0] mgmtsoc_ibex_interface_dbus_dat_r;
reg [3:0] mgmtsoc_ibex_interface_dbus_sel = 4'd0;
reg mgmtsoc_ibex_interface_dbus_cyc = 1'd0;
reg mgmtsoc_ibex_interface_dbus_stb = 1'd0;
wire mgmtsoc_ibex_interface_dbus_ack;
reg mgmtsoc_ibex_interface_dbus_we = 1'd0;
reg [2:0] mgmtsoc_ibex_interface_dbus_cti = 3'd0;
reg [1:0] mgmtsoc_ibex_interface_dbus_bte = 2'd0;
wire mgmtsoc_ibex_interface_dbus_err;
reg [14:0] mgmtsoc_ibex_interrupt = 15'd0;
wire mgmtsoc_ibex_record_ibus_req;
reg mgmtsoc_ibex_record_ibus_gnt = 1'd0;
wire [31:0] mgmtsoc_ibex_record_ibus_addr;
wire mgmtsoc_ibex_record_ibus_we;
wire [3:0] mgmtsoc_ibex_record_ibus_be;
reg [31:0] mgmtsoc_ibex_record_ibus_wdata = 32'd0;
reg mgmtsoc_ibex_record_ibus_rvalid = 1'd0;
reg [31:0] mgmtsoc_ibex_record_ibus_rdata = 32'd0;
wire mgmtsoc_ibex_record_dbus_req;
reg mgmtsoc_ibex_record_dbus_gnt = 1'd0;
wire [31:0] mgmtsoc_ibex_record_dbus_addr;
wire mgmtsoc_ibex_record_dbus_we;
wire [3:0] mgmtsoc_ibex_record_dbus_be;
wire [31:0] mgmtsoc_ibex_record_dbus_wdata;
reg mgmtsoc_ibex_record_dbus_rvalid = 1'd0;
reg [31:0] mgmtsoc_ibex_record_dbus_rdata = 32'd0;
reg [31:0] mgmtsoc_ibex_ibus_conv_addr = 32'd0;
reg [3:0] mgmtsoc_ibex_ibus_conv_be = 4'd0;
reg mgmtsoc_ibex_ibus_conv_we = 1'd0;
reg [31:0] mgmtsoc_ibex_ibus_conv_wdata = 32'd0;
reg [31:0] mgmtsoc_ibex_dbus_conv_addr = 32'd0;
reg [3:0] mgmtsoc_ibex_dbus_conv_be = 4'd0;
reg mgmtsoc_ibex_dbus_conv_we = 1'd0;
reg [31:0] mgmtsoc_ibex_dbus_conv_wdata = 32'd0;
wire mgmtsoc_ibex0;
wire mgmtsoc_ibex1;
wire mgmtsoc_ibex2;
reg [31:0] mgmtsoc_ibex3 = 32'd268435456;
...
reg mgmtsoc_rxtx_re = 1'd0;
wire [7:0] mgmtsoc_rxtx_r;
reg mgmtsoc_rxtx_we = 1'd0;
wire [7:0] mgmtsoc_rxtx_w;
wire mgmtsoc_txfull_status;
wire mgmtsoc_txfull_we;
reg mgmtsoc_txfull_re = 1'd0;
wire mgmtsoc_rxempty_status;
wire mgmtsoc_rxempty_we;
reg mgmtsoc_rxempty_re = 1'd0;
wire mgmtsoc_irq;
wire mgmtsoc_tx_status;
reg mgmtsoc_tx_pending = 1'd0;
wire mgmtsoc_tx_trigger;
reg mgmtsoc_tx_clear = 1'd0;
reg mgmtsoc_tx_trigger_d = 1'd0;
wire mgmtsoc_rx_status;
reg mgmtsoc_rx_pending = 1'd0;
wire mgmtsoc_rx_trigger;
reg mgmtsoc_rx_clear = 1'd0;
reg mgmtsoc_rx_trigger_d = 1'd0;
wire mgmtsoc_tx0;
wire mgmtsoc_rx0;
reg [1:0] mgmtsoc_status_status = 2'd0;
wire mgmtsoc_status_we;
reg mgmtsoc_status_re = 1'd0;
wire mgmtsoc_tx1;
wire mgmtsoc_rx1;
reg [1:0] mgmtsoc_pending_status = 2'd0;
wire mgmtsoc_pending_we;
reg mgmtsoc_pending_re = 1'd0;
reg [1:0] mgmtsoc_pending_r = 2'd0;
wire mgmtsoc_tx2;
wire mgmtsoc_rx2;
reg [1:0] mgmtsoc_enable_storage = 2'd0;
reg mgmtsoc_enable_re = 1'd0;
wire mgmtsoc_txempty_status;
wire mgmtsoc_txempty_we;
reg mgmtsoc_txempty_re = 1'd0;
wire mgmtsoc_rxfull_status;
wire mgmtsoc_rxfull_we;
reg mgmtsoc_rxfull_re = 1'd0;
wire mgmtsoc_uart_sink_valid;
wire mgmtsoc_uart_sink_ready;
wire mgmtsoc_uart_sink_first;
wire mgmtsoc_uart_sink_last;
wire [7:0] mgmtsoc_uart_sink_payload_data;
wire mgmtsoc_uart_source_valid;
wire mgmtsoc_uart_source_ready;
wire mgmtsoc_uart_source_first;
wire mgmtsoc_uart_source_last;
wire [7:0] mgmtsoc_uart_source_payload_data;
wire mgmtsoc_tx_fifo_sink_valid;
wire mgmtsoc_tx_fifo_sink_ready;
reg mgmtsoc_tx_fifo_sink_first = 1'd0;
reg mgmtsoc_tx_fifo_sink_last = 1'd0;
wire [7:0] mgmtsoc_tx_fifo_sink_payload_data;
wire mgmtsoc_tx_fifo_source_valid;
wire mgmtsoc_tx_fifo_source_ready;
wire mgmtsoc_tx_fifo_source_first;
wire mgmtsoc_tx_fifo_source_last;
wire [7:0] mgmtsoc_tx_fifo_source_payload_data;
wire mgmtsoc_tx_fifo_re;
reg mgmtsoc_tx_fifo_readable = 1'd0;
wire mgmtsoc_tx_fifo_syncfifo_we;
wire mgmtsoc_tx_fifo_syncfifo_writable;
wire mgmtsoc_tx_fifo_syncfifo_re;
wire mgmtsoc_tx_fifo_syncfifo_readable;
wire [9:0] mgmtsoc_tx_fifo_syncfifo_din;
wire [9:0] mgmtsoc_tx_fifo_syncfifo_dout;
reg [4:0] mgmtsoc_tx_fifo_level0 = 5'd0;
reg mgmtsoc_tx_fifo_replace = 1'd0;
reg [3:0] mgmtsoc_tx_fifo_produce = 4'd0;
reg [3:0] mgmtsoc_tx_fifo_consume = 4'd0;
reg [3:0] mgmtsoc_tx_fifo_wrport_adr = 4'd0;
wire [9:0] mgmtsoc_tx_fifo_wrport_dat_r;
wire mgmtsoc_tx_fifo_wrport_we;
wire [9:0] mgmtsoc_tx_fifo_wrport_dat_w;
wire mgmtsoc_tx_fifo_do_read;
wire [3:0] mgmtsoc_tx_fifo_rdport_adr;
wire [9:0] mgmtsoc_tx_fifo_rdport_dat_r;
wire mgmtsoc_tx_fifo_rdport_re;
wire [4:0] mgmtsoc_tx_fifo_level1;
wire [7:0] mgmtsoc_tx_fifo_fifo_in_payload_data;
wire mgmtsoc_tx_fifo_fifo_in_first;
wire mgmtsoc_tx_fifo_fifo_in_last;
wire [7:0] mgmtsoc_tx_fifo_fifo_out_payload_data;
wire mgmtsoc_tx_fifo_fifo_out_first;
wire mgmtsoc_tx_fifo_fifo_out_last;
wire mgmtsoc_rx_fifo_sink_valid;
wire mgmtsoc_rx_fifo_sink_ready;
wire mgmtsoc_rx_fifo_sink_first;
wire mgmtsoc_rx_fifo_sink_last;
wire [7:0] mgmtsoc_rx_fifo_sink_payload_data;
wire mgmtsoc_rx_fifo_source_valid;
wire mgmtsoc_rx_fifo_source_ready;
wire mgmtsoc_rx_fifo_source_first;
wire mgmtsoc_rx_fifo_source_last;
wire [7:0] mgmtsoc_rx_fifo_source_payload_data;
wire mgmtsoc_rx_fifo_re;
reg mgmtsoc_rx_fifo_readable = 1'd0;
wire mgmtsoc_rx_fifo_syncfifo_we;
wire mgmtsoc_rx_fifo_syncfifo_writable;
wire mgmtsoc_rx_fifo_syncfifo_re;
wire mgmtsoc_rx_fifo_syncfifo_readable;
wire [9:0] mgmtsoc_rx_fifo_syncfifo_din;
wire [9:0] mgmtsoc_rx_fifo_syncfifo_dout;
reg [4:0] mgmtsoc_rx_fifo_level0 = 5'd0;
reg mgmtsoc_rx_fifo_replace = 1'd0;
reg [3:0] mgmtsoc_rx_fifo_produce = 4'd0;
reg [3:0] mgmtsoc_rx_fifo_consume = 4'd0;
reg [3:0] mgmtsoc_rx_fifo_wrport_adr = 4'd0;
wire [9:0] mgmtsoc_rx_fifo_wrport_dat_r;
wire mgmtsoc_rx_fifo_wrport_we;
wire [9:0] mgmtsoc_rx_fifo_wrport_dat_w;
wire mgmtsoc_rx_fifo_do_read;
wire [3:0] mgmtsoc_rx_fifo_rdport_adr;
wire [9:0] mgmtsoc_rx_fifo_rdport_dat_r;
wire mgmtsoc_rx_fifo_rdport_re;
wire [4:0] mgmtsoc_rx_fifo_level1;
wire [7:0] mgmtsoc_rx_fifo_fifo_in_payload_data;
wire mgmtsoc_rx_fifo_fifo_in_first;
wire mgmtsoc_rx_fifo_fifo_in_last;
wire [7:0] mgmtsoc_rx_fifo_fifo_out_payload_data;
wire mgmtsoc_rx_fifo_fifo_out_first;
wire mgmtsoc_rx_fifo_fifo_out_last;
...
reg obi2wishbone0_state = 1'd0;
reg obi2wishbone0_next_state = 1'd0;
reg [31:0] mgmtsoc_ibex_ibus_conv_addr_obi2wishbone0_next_value0 = 32'd0;
reg mgmtsoc_ibex_ibus_conv_addr_obi2wishbone0_next_value_ce0 = 1'd0;
reg [3:0] mgmtsoc_ibex_ibus_conv_be_obi2wishbone0_next_value1 = 4'd0;
reg mgmtsoc_ibex_ibus_conv_be_obi2wishbone0_next_value_ce1 = 1'd0;
reg mgmtsoc_ibex_ibus_conv_we_obi2wishbone0_next_value2 = 1'd0;
reg mgmtsoc_ibex_ibus_conv_we_obi2wishbone0_next_value_ce2 = 1'd0;
reg [31:0] mgmtsoc_ibex_ibus_conv_wdata_obi2wishbone0_next_value3 = 32'd0;
reg mgmtsoc_ibex_ibus_conv_wdata_obi2wishbone0_next_value_ce3 = 1'd0;
reg obi2wishbone1_state = 1'd0;
reg obi2wishbone1_next_state = 1'd0;
reg [31:0] mgmtsoc_ibex_dbus_conv_addr_obi2wishbone1_next_value0 = 32'd0;
reg mgmtsoc_ibex_dbus_conv_addr_obi2wishbone1_next_value_ce0 = 1'd0;
reg [3:0] mgmtsoc_ibex_dbus_conv_be_obi2wishbone1_next_value1 = 4'd0;
reg mgmtsoc_ibex_dbus_conv_be_obi2wishbone1_next_value_ce1 = 1'd0;
reg mgmtsoc_ibex_dbus_conv_we_obi2wishbone1_next_value2 = 1'd0;
reg mgmtsoc_ibex_dbus_conv_we_obi2wishbone1_next_value_ce2 = 1'd0;
reg [31:0] mgmtsoc_ibex_dbus_conv_wdata_obi2wishbone1_next_value3 = 32'd0;
reg mgmtsoc_ibex_dbus_conv_wdata_obi2wishbone1_next_value_ce3 = 1'd0;
...
reg [3:0] debug_tx_count_uartwishbonebridge_rs232phytx_next_value0 = 4'd0;
reg debug_tx_count_uartwishbonebridge_rs232phytx_next_value_ce0 = 1'd0;
reg debug_tx_uartwishbonebridge_rs232phytx_next_value1 = 1'd0;
reg debug_tx_uartwishbonebridge_rs232phytx_next_value_ce1 = 1'd0;
reg [7:0] debug_tx_data_uartwishbonebridge_rs232phytx_next_value2 = 8'd0;
reg debug_tx_data_uartwishbonebridge_rs232phytx_next_value_ce2 = 1'd0;
reg uartwishbonebridge_rs232phyrx_state = 1'd0;
reg uartwishbonebridge_rs232phyrx_next_state = 1'd0;
reg [3:0] debug_rx_count_uartwishbonebridge_rs232phyrx_next_value0 = 4'd0;
reg debug_rx_count_uartwishbonebridge_rs232phyrx_next_value_ce0 = 1'd0;
reg [7:0] debug_rx_data_uartwishbonebridge_rs232phyrx_next_value1 = 8'd0;
reg debug_rx_data_uartwishbonebridge_rs232phyrx_next_value_ce1 = 1'd0;
reg [2:0] uartwishbonebridge_state = 3'd0;
reg [2:0] uartwishbonebridge_next_state = 3'd0;
reg [1:0] debug_bytes_count_uartwishbonebridge_next_value0 = 2'd0;
reg debug_bytes_count_uartwishbonebridge_next_value_ce0 = 1'd0;
reg [7:0] debug_words_count_uartwishbonebridge_next_value1 = 8'd0;
reg debug_words_count_uartwishbonebridge_next_value_ce1 = 1'd0;
reg [7:0] debug_cmd_uartwishbonebridge_next_value2 = 8'd0;
reg debug_cmd_uartwishbonebridge_next_value_ce2 = 1'd0;
reg [7:0] debug_length_uartwishbonebridge_next_value3 = 8'd0;
reg debug_length_uartwishbonebridge_next_value_ce3 = 1'd0;
reg [31:0] debug_address_uartwishbonebridge_next_value4 = 32'd0;
reg debug_address_uartwishbonebridge_next_value_ce4 = 1'd0;
reg debug_incr_uartwishbonebridge_next_value5 = 1'd0;
reg debug_incr_uartwishbonebridge_next_value_ce5 = 1'd0;
reg [31:0] debug_data_uartwishbonebridge_next_value6 = 32'd0;
reg debug_data_uartwishbonebridge_next_value_ce6 = 1'd0;
wire gpioin0_i00;
...
assign mgmtsoc_ibex_reset = (mgmtsoc_soc_rst | mgmtsoc_cpu_rst);
...
always @(*) begin
	mgmtsoc_ibex_interrupt = 15'd0;
	mgmtsoc_ibex_interrupt[0] = mgmtsoc_irq;
	mgmtsoc_ibex_interrupt[1] = gpioin0_gpioin0_irq;
	mgmtsoc_ibex_interrupt[2] = gpioin1_gpioin1_irq;
	mgmtsoc_ibex_interrupt[3] = gpioin2_gpioin2_irq;
	mgmtsoc_ibex_interrupt[4] = gpioin3_gpioin3_irq;
	mgmtsoc_ibex_interrupt[5] = gpioin4_gpioin4_irq;
	mgmtsoc_ibex_interrupt[6] = gpioin5_gpioin5_irq;
end
assign sys_clk = core_clk;
assign por_clk = core_clk;
assign sys_rst = int_rst;
assign mgmtsoc_bus_errors_status = mgmtsoc_bus_errors;
assign mgmtsoc_ibex_record_ibus_we = 1'd0;
assign mgmtsoc_ibex_record_ibus_be = 11'd1111;
always @(*) begin
	obi2wishbone0_next_state = 1'd0;
	obi2wishbone0_next_state = obi2wishbone0_state;
	case (obi2wishbone0_state)
		1'd1: begin
			if (mgmtsoc_ibex_interface_ibus_ack) begin
				obi2wishbone0_next_state = 1'd0;
			end
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				obi2wishbone0_next_state = 1'd1;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_ibus_stb = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
			mgmtsoc_ibex_interface_ibus_stb = 1'd1;
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_interface_ibus_stb = 1'd1;
...
always @(*) begin
	mgmtsoc_ibex_ibus_conv_we_obi2wishbone0_next_value2 = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_ibus_conv_we_obi2wishbone0_next_value2 = mgmtsoc_ibex_record_ibus_we;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_ibus_conv_we_obi2wishbone0_next_value_ce2 = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_ibus_conv_we_obi2wishbone0_next_value_ce2 = 1'd1;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_ibus_we = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
			mgmtsoc_ibex_interface_ibus_we = mgmtsoc_ibex_ibus_conv_we;
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_interface_ibus_we = mgmtsoc_ibex_record_ibus_we;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_ibus_conv_wdata_obi2wishbone0_next_value3 = 32'd0;
	case (obi2wishbone0_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_ibus_conv_wdata_obi2wishbone0_next_value3 = mgmtsoc_ibex_record_ibus_wdata;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_record_ibus_gnt = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
		end
		default: begin
			mgmtsoc_ibex_record_ibus_gnt = 1'd1;
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_ibus_conv_wdata_obi2wishbone0_next_value_ce3 = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_ibus_conv_wdata_obi2wishbone0_next_value_ce3 = 1'd1;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_ibus_conv_addr_obi2wishbone0_next_value_ce0 = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_ibus_conv_addr_obi2wishbone0_next_value_ce0 = 1'd1;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_record_ibus_rvalid = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
			if (mgmtsoc_ibex_interface_ibus_ack) begin
				mgmtsoc_ibex_record_ibus_rvalid = 1'd1;
			end
		end
		default: begin
		end
...
always @(*) begin
	mgmtsoc_ibex_record_ibus_rdata = 32'd0;
	case (obi2wishbone0_state)
		1'd1: begin
			if (mgmtsoc_ibex_interface_ibus_ack) begin
				mgmtsoc_ibex_record_ibus_rdata = mgmtsoc_ibex_interface_ibus_dat_r;
			end
		end
		default: begin
		end
...
always @(*) begin
	mgmtsoc_ibex_interface_ibus_adr = 30'd0;
	case (obi2wishbone0_state)
		1'd1: begin
			mgmtsoc_ibex_interface_ibus_adr = mgmtsoc_ibex_ibus_conv_addr[31:2];
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_interface_ibus_adr = mgmtsoc_ibex_record_ibus_addr[31:2];
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_ibus_conv_addr_obi2wishbone0_next_value0 = 32'd0;
	case (obi2wishbone0_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_ibus_conv_addr_obi2wishbone0_next_value0 = mgmtsoc_ibex_record_ibus_addr;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_ibus_dat_w = 32'd0;
	case (obi2wishbone0_state)
		1'd1: begin
			mgmtsoc_ibex_interface_ibus_dat_w = mgmtsoc_ibex_ibus_conv_wdata;
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_interface_ibus_dat_w = mgmtsoc_ibex_record_ibus_wdata;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_ibus_conv_be_obi2wishbone0_next_value1 = 4'd0;
	case (obi2wishbone0_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_ibus_conv_be_obi2wishbone0_next_value1 = mgmtsoc_ibex_record_ibus_be;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_ibus_sel = 4'd0;
	case (obi2wishbone0_state)
		1'd1: begin
			mgmtsoc_ibex_interface_ibus_sel = mgmtsoc_ibex_ibus_conv_be;
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_interface_ibus_sel = mgmtsoc_ibex_record_ibus_be;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_ibus_conv_be_obi2wishbone0_next_value_ce1 = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_ibus_conv_be_obi2wishbone0_next_value_ce1 = 1'd1;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_ibus_cyc = 1'd0;
	case (obi2wishbone0_state)
		1'd1: begin
			mgmtsoc_ibex_interface_ibus_cyc = 1'd1;
		end
		default: begin
			if (mgmtsoc_ibex_record_ibus_req) begin
				mgmtsoc_ibex_interface_ibus_cyc = 1'd1;
...
always @(*) begin
	obi2wishbone1_next_state = 1'd0;
	obi2wishbone1_next_state = obi2wishbone1_state;
	case (obi2wishbone1_state)
		1'd1: begin
			if (mgmtsoc_ibex_interface_dbus_ack) begin
				obi2wishbone1_next_state = 1'd0;
			end
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				obi2wishbone1_next_state = 1'd1;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_record_dbus_rvalid = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
			if (mgmtsoc_ibex_interface_dbus_ack) begin
				mgmtsoc_ibex_record_dbus_rvalid = 1'd1;
			end
		end
		default: begin
		end
...
always @(*) begin
	mgmtsoc_ibex_dbus_conv_we_obi2wishbone1_next_value2 = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_dbus_conv_we_obi2wishbone1_next_value2 = mgmtsoc_ibex_record_dbus_we;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_record_dbus_rdata = 32'd0;
	case (obi2wishbone1_state)
		1'd1: begin
			if (mgmtsoc_ibex_interface_dbus_ack) begin
				mgmtsoc_ibex_record_dbus_rdata = mgmtsoc_ibex_interface_dbus_dat_r;
			end
		end
		default: begin
		end
...
always @(*) begin
	mgmtsoc_ibex_dbus_conv_we_obi2wishbone1_next_value_ce2 = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_dbus_conv_we_obi2wishbone1_next_value_ce2 = 1'd1;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_dbus_conv_wdata_obi2wishbone1_next_value3 = 32'd0;
	case (obi2wishbone1_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_dbus_conv_wdata_obi2wishbone1_next_value3 = mgmtsoc_ibex_record_dbus_wdata;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_dbus_conv_wdata_obi2wishbone1_next_value_ce3 = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_dbus_conv_wdata_obi2wishbone1_next_value_ce3 = 1'd1;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_dbus_adr = 30'd0;
	case (obi2wishbone1_state)
		1'd1: begin
			mgmtsoc_ibex_interface_dbus_adr = mgmtsoc_ibex_dbus_conv_addr[31:2];
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_interface_dbus_adr = mgmtsoc_ibex_record_dbus_addr[31:2];
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_dbus_dat_w = 32'd0;
	case (obi2wishbone1_state)
		1'd1: begin
			mgmtsoc_ibex_interface_dbus_dat_w = mgmtsoc_ibex_dbus_conv_wdata;
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_interface_dbus_dat_w = mgmtsoc_ibex_record_dbus_wdata;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_dbus_sel = 4'd0;
	case (obi2wishbone1_state)
		1'd1: begin
			mgmtsoc_ibex_interface_dbus_sel = mgmtsoc_ibex_dbus_conv_be;
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_interface_dbus_sel = mgmtsoc_ibex_record_dbus_be;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_dbus_cyc = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
			mgmtsoc_ibex_interface_dbus_cyc = 1'd1;
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_interface_dbus_cyc = 1'd1;
...
always @(*) begin
	mgmtsoc_ibex_interface_dbus_stb = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
			mgmtsoc_ibex_interface_dbus_stb = 1'd1;
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_interface_dbus_stb = 1'd1;
...
always @(*) begin
	mgmtsoc_ibex_dbus_conv_addr_obi2wishbone1_next_value0 = 32'd0;
	case (obi2wishbone1_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_dbus_conv_addr_obi2wishbone1_next_value0 = mgmtsoc_ibex_record_dbus_addr;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_record_dbus_gnt = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
		end
		default: begin
			mgmtsoc_ibex_record_dbus_gnt = 1'd1;
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_dbus_conv_addr_obi2wishbone1_next_value_ce0 = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_dbus_conv_addr_obi2wishbone1_next_value_ce0 = 1'd1;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_interface_dbus_we = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
			mgmtsoc_ibex_interface_dbus_we = mgmtsoc_ibex_dbus_conv_we;
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_interface_dbus_we = mgmtsoc_ibex_record_dbus_we;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_dbus_conv_be_obi2wishbone1_next_value1 = 4'd0;
	case (obi2wishbone1_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_dbus_conv_be_obi2wishbone1_next_value1 = mgmtsoc_ibex_record_dbus_be;
			end
		end
	endcase
end
always @(*) begin
	mgmtsoc_ibex_dbus_conv_be_obi2wishbone1_next_value_ce1 = 1'd0;
	case (obi2wishbone1_state)
		1'd1: begin
		end
		default: begin
			if (mgmtsoc_ibex_record_dbus_req) begin
				mgmtsoc_ibex_dbus_conv_be_obi2wishbone1_next_value_ce1 = 1'd1;
			end
		end
	endcase
end
...
assign mgmtsoc_uart_sink_valid = mgmtsoc_rx_source_valid;
assign mgmtsoc_rx_source_ready = mgmtsoc_uart_sink_ready;
assign mgmtsoc_uart_sink_first = mgmtsoc_rx_source_first;
assign mgmtsoc_uart_sink_last = mgmtsoc_rx_source_last;
assign mgmtsoc_uart_sink_payload_data = mgmtsoc_rx_source_payload_data;
assign mgmtsoc_tx_sink_valid = mgmtsoc_uart_source_valid;
assign mgmtsoc_uart_source_ready = mgmtsoc_tx_sink_ready;
assign mgmtsoc_tx_sink_first = mgmtsoc_uart_source_first;
assign mgmtsoc_tx_sink_last = mgmtsoc_uart_source_last;
assign mgmtsoc_tx_sink_payload_data = mgmtsoc_uart_source_payload_data;
assign mgmtsoc_tx_fifo_sink_valid = mgmtsoc_rxtx_re;
assign mgmtsoc_tx_fifo_sink_payload_data = mgmtsoc_rxtx_r;
assign mgmtsoc_uart_source_valid = mgmtsoc_tx_fifo_source_valid;
assign mgmtsoc_tx_fifo_source_ready = mgmtsoc_uart_source_ready;
assign mgmtsoc_uart_source_first = mgmtsoc_tx_fifo_source_first;
assign mgmtsoc_uart_source_last = mgmtsoc_tx_fifo_source_last;
assign mgmtsoc_uart_source_payload_data = mgmtsoc_tx_fifo_source_payload_data;
assign mgmtsoc_txfull_status = (~mgmtsoc_tx_fifo_sink_ready);
assign mgmtsoc_txempty_status = (~mgmtsoc_tx_fifo_source_valid);
assign mgmtsoc_tx_trigger = mgmtsoc_tx_fifo_sink_ready;
assign mgmtsoc_rx_fifo_sink_valid = mgmtsoc_uart_sink_valid;
assign mgmtsoc_uart_sink_ready = mgmtsoc_rx_fifo_sink_ready;
assign mgmtsoc_rx_fifo_sink_first = mgmtsoc_uart_sink_first;
assign mgmtsoc_rx_fifo_sink_last = mgmtsoc_uart_sink_last;
assign mgmtsoc_rx_fifo_sink_payload_data = mgmtsoc_uart_sink_payload_data;
assign mgmtsoc_rxtx_w = mgmtsoc_rx_fifo_source_payload_data;
assign mgmtsoc_rx_fifo_source_ready = (mgmtsoc_rx_clear | (1'd0 & mgmtsoc_rxtx_we));
assign mgmtsoc_rxempty_status = (~mgmtsoc_rx_fifo_source_valid);
assign mgmtsoc_rxfull_status = (~mgmtsoc_rx_fifo_sink_ready);
assign mgmtsoc_rx_trigger = mgmtsoc_rx_fifo_source_valid;
assign mgmtsoc_tx0 = mgmtsoc_tx_status;
assign mgmtsoc_tx1 = mgmtsoc_tx_pending;
always @(*) begin
	mgmtsoc_tx_clear = 1'd0;
	if ((mgmtsoc_pending_re & mgmtsoc_pending_r[0])) begin
		mgmtsoc_tx_clear = 1'd1;
	end
end
assign mgmtsoc_rx0 = mgmtsoc_rx_status;
assign mgmtsoc_rx1 = mgmtsoc_rx_pending;
always @(*) begin
	mgmtsoc_rx_clear = 1'd0;
	if ((mgmtsoc_pending_re & mgmtsoc_pending_r[1])) begin
		mgmtsoc_rx_clear = 1'd1;
	end
end
assign mgmtsoc_irq = ((mgmtsoc_pending_status[0] & mgmtsoc_enable_storage[0]) | (mgmtsoc_pending_status[1] & mgmtsoc_enable_storage[1]));
assign mgmtsoc_tx_status = mgmtsoc_tx_trigger;
assign mgmtsoc_rx_status = mgmtsoc_rx_trigger;
assign mgmtsoc_tx_fifo_syncfifo_din = {mgmtsoc_tx_fifo_fifo_in_last, mgmtsoc_tx_fifo_fifo_in_first, mgmtsoc_tx_fifo_fifo_in_payload_data};
assign {mgmtsoc_tx_fifo_fifo_out_last, mgmtsoc_tx_fifo_fifo_out_first, mgmtsoc_tx_fifo_fifo_out_payload_data} = mgmtsoc_tx_fifo_syncfifo_dout;
assign {mgmtsoc_tx_fifo_fifo_out_last, mgmtsoc_tx_fifo_fifo_out_first, mgmtsoc_tx_fifo_fifo_out_payload_data} = mgmtsoc_tx_fifo_syncfifo_dout;
assign {mgmtsoc_tx_fifo_fifo_out_last, mgmtsoc_tx_fifo_fifo_out_first, mgmtsoc_tx_fifo_fifo_out_payload_data} = mgmtsoc_tx_fifo_syncfifo_dout;
assign mgmtsoc_tx_fifo_sink_ready = mgmtsoc_tx_fifo_syncfifo_writable;
assign mgmtsoc_tx_fifo_syncfifo_we = mgmtsoc_tx_fifo_sink_valid;
assign mgmtsoc_tx_fifo_fifo_in_first = mgmtsoc_tx_fifo_sink_first;
assign mgmtsoc_tx_fifo_fifo_in_last = mgmtsoc_tx_fifo_sink_last;
assign mgmtsoc_tx_fifo_fifo_in_payload_data = mgmtsoc_tx_fifo_sink_payload_data;
assign mgmtsoc_tx_fifo_source_valid = mgmtsoc_tx_fifo_readable;
assign mgmtsoc_tx_fifo_source_first = mgmtsoc_tx_fifo_fifo_out_first;
assign mgmtsoc_tx_fifo_source_last = mgmtsoc_tx_fifo_fifo_out_last;
assign mgmtsoc_tx_fifo_source_payload_data = mgmtsoc_tx_fifo_fifo_out_payload_data;
assign mgmtsoc_tx_fifo_re = mgmtsoc_tx_fifo_source_ready;
assign mgmtsoc_tx_fifo_syncfifo_re = (mgmtsoc_tx_fifo_syncfifo_readable & ((~mgmtsoc_tx_fifo_readable) | mgmtsoc_tx_fifo_re));
assign mgmtsoc_tx_fifo_level1 = (mgmtsoc_tx_fifo_level0 + mgmtsoc_tx_fifo_readable);
always @(*) begin
	mgmtsoc_tx_fifo_wrport_adr = 4'd0;
	if (mgmtsoc_tx_fifo_replace) begin
		mgmtsoc_tx_fifo_wrport_adr = (mgmtsoc_tx_fifo_produce - 1'd1);
	end else begin
		mgmtsoc_tx_fifo_wrport_adr = mgmtsoc_tx_fifo_produce;
	end
end
assign mgmtsoc_tx_fifo_wrport_dat_w = mgmtsoc_tx_fifo_syncfifo_din;
assign mgmtsoc_tx_fifo_wrport_we = (mgmtsoc_tx_fifo_syncfifo_we & (mgmtsoc_tx_fifo_syncfifo_writable | mgmtsoc_tx_fifo_replace));
assign mgmtsoc_tx_fifo_do_read = (mgmtsoc_tx_fifo_syncfifo_readable & mgmtsoc_tx_fifo_syncfifo_re);
assign mgmtsoc_tx_fifo_rdport_adr = mgmtsoc_tx_fifo_consume;
assign mgmtsoc_tx_fifo_syncfifo_dout = mgmtsoc_tx_fifo_rdport_dat_r;
assign mgmtsoc_tx_fifo_rdport_re = mgmtsoc_tx_fifo_do_read;
assign mgmtsoc_tx_fifo_syncfifo_writable = (mgmtsoc_tx_fifo_level0 != 5'd16);
assign mgmtsoc_tx_fifo_syncfifo_readable = (mgmtsoc_tx_fifo_level0 != 1'd0);
assign mgmtsoc_rx_fifo_syncfifo_din = {mgmtsoc_rx_fifo_fifo_in_last, mgmtsoc_rx_fifo_fifo_in_first, mgmtsoc_rx_fifo_fifo_in_payload_data};
assign {mgmtsoc_rx_fifo_fifo_out_last, mgmtsoc_rx_fifo_fifo_out_first, mgmtsoc_rx_fifo_fifo_out_payload_data} = mgmtsoc_rx_fifo_syncfifo_dout;
assign {mgmtsoc_rx_fifo_fifo_out_last, mgmtsoc_rx_fifo_fifo_out_first, mgmtsoc_rx_fifo_fifo_out_payload_data} = mgmtsoc_rx_fifo_syncfifo_dout;
assign {mgmtsoc_rx_fifo_fifo_out_last, mgmtsoc_rx_fifo_fifo_out_first, mgmtsoc_rx_fifo_fifo_out_payload_data} = mgmtsoc_rx_fifo_syncfifo_dout;
assign mgmtsoc_rx_fifo_sink_ready = mgmtsoc_rx_fifo_syncfifo_writable;
assign mgmtsoc_rx_fifo_syncfifo_we = mgmtsoc_rx_fifo_sink_valid;
assign mgmtsoc_rx_fifo_fifo_in_first = mgmtsoc_rx_fifo_sink_first;
assign mgmtsoc_rx_fifo_fifo_in_last = mgmtsoc_rx_fifo_sink_last;
assign mgmtsoc_rx_fifo_fifo_in_payload_data = mgmtsoc_rx_fifo_sink_payload_data;
assign mgmtsoc_rx_fifo_source_valid = mgmtsoc_rx_fifo_readable;
assign mgmtsoc_rx_fifo_source_first = mgmtsoc_rx_fifo_fifo_out_first;
assign mgmtsoc_rx_fifo_source_last = mgmtsoc_rx_fifo_fifo_out_last;
assign mgmtsoc_rx_fifo_source_payload_data = mgmtsoc_rx_fifo_fifo_out_payload_data;
assign mgmtsoc_rx_fifo_re = mgmtsoc_rx_fifo_source_ready;
assign mgmtsoc_rx_fifo_syncfifo_re = (mgmtsoc_rx_fifo_syncfifo_readable & ((~mgmtsoc_rx_fifo_readable) | mgmtsoc_rx_fifo_re));
assign mgmtsoc_rx_fifo_level1 = (mgmtsoc_rx_fifo_level0 + mgmtsoc_rx_fifo_readable);
always @(*) begin
	mgmtsoc_rx_fifo_wrport_adr = 4'd0;
	if (mgmtsoc_rx_fifo_replace) begin
		mgmtsoc_rx_fifo_wrport_adr = (mgmtsoc_rx_fifo_produce - 1'd1);
	end else begin
		mgmtsoc_rx_fifo_wrport_adr = mgmtsoc_rx_fifo_produce;
	end
end
assign mgmtsoc_rx_fifo_wrport_dat_w = mgmtsoc_rx_fifo_syncfifo_din;
assign mgmtsoc_rx_fifo_wrport_we = (mgmtsoc_rx_fifo_syncfifo_we & (mgmtsoc_rx_fifo_syncfifo_writable | mgmtsoc_rx_fifo_replace));
assign mgmtsoc_rx_fifo_do_read = (mgmtsoc_rx_fifo_syncfifo_readable & mgmtsoc_rx_fifo_syncfifo_re);
assign mgmtsoc_rx_fifo_rdport_adr = mgmtsoc_rx_fifo_consume;
assign mgmtsoc_rx_fifo_syncfifo_dout = mgmtsoc_rx_fifo_rdport_dat_r;
assign mgmtsoc_rx_fifo_rdport_re = mgmtsoc_rx_fifo_do_read;
assign mgmtsoc_rx_fifo_syncfifo_writable = (mgmtsoc_rx_fifo_level0 != 5'd16);
assign mgmtsoc_rx_fifo_syncfifo_readable = (mgmtsoc_rx_fifo_level0 != 1'd0);
...
always @(*) begin
	debug_tx_data_uartwishbonebridge_rs232phytx_next_value2 = 8'd0;
	case (uartwishbonebridge_rs232phytx_state)
		1'd1: begin
			if (debug_tx_tick) begin
				debug_tx_data_uartwishbonebridge_rs232phytx_next_value2 = {1'd1, debug_tx_data[7:1]};
			end
		end
		default: begin
			if (debug_tx_sink_valid) begin
				debug_tx_data_uartwishbonebridge_rs232phytx_next_value2 = debug_tx_sink_payload_data;
			end
		end
	endcase
end
always @(*) begin
	debug_tx_data_uartwishbonebridge_rs232phytx_next_value_ce2 = 1'd0;
	case (uartwishbonebridge_rs232phytx_state)
		1'd1: begin
			if (debug_tx_tick) begin
				debug_tx_data_uartwishbonebridge_rs232phytx_next_value_ce2 = 1'd1;
			end
		end
		default: begin
			if (debug_tx_sink_valid) begin
...
always @(*) begin
	debug_tx_count_uartwishbonebridge_rs232phytx_next_value0 = 4'd0;
	case (uartwishbonebridge_rs232phytx_state)
		1'd1: begin
			if (debug_tx_tick) begin
				debug_tx_count_uartwishbonebridge_rs232phytx_next_value0 = (debug_tx_count + 1'd1);
			end
		end
		default: begin
			debug_tx_count_uartwishbonebridge_rs232phytx_next_value0 = 1'd0;
		end
	endcase
end
always @(*) begin
	debug_tx_count_uartwishbonebridge_rs232phytx_next_value_ce0 = 1'd0;
	case (uartwishbonebridge_rs232phytx_state)
		1'd1: begin
			if (debug_tx_tick) begin
				debug_tx_count_uartwishbonebridge_rs232phytx_next_value_ce0 = 1'd1;
			end
		end
		default: begin
			debug_tx_count_uartwishbonebridge_rs232phytx_next_value_ce0 = 1'd1;
...
always @(*) begin
	debug_tx_uartwishbonebridge_rs232phytx_next_value1 = 1'd0;
	case (uartwishbonebridge_rs232phytx_state)
		1'd1: begin
			if (debug_tx_tick) begin
				debug_tx_uartwishbonebridge_rs232phytx_next_value1 = debug_tx_data;
			end
		end
		default: begin
			debug_tx_uartwishbonebridge_rs232phytx_next_value1 = 1'd1;
			if (debug_tx_sink_valid) begin
				debug_tx_uartwishbonebridge_rs232phytx_next_value1 = 1'd0;
			end
		end
...
always @(*) begin
	debug_tx_uartwishbonebridge_rs232phytx_next_value_ce1 = 1'd0;
	case (uartwishbonebridge_rs232phytx_state)
		1'd1: begin
			if (debug_tx_tick) begin
				debug_tx_uartwishbonebridge_rs232phytx_next_value_ce1 = 1'd1;
			end
		end
		default: begin
			debug_tx_uartwishbonebridge_rs232phytx_next_value_ce1 = 1'd1;
...
always @(*) begin
	debug_rx_data_uartwishbonebridge_rs232phyrx_next_value_ce1 = 1'd0;
	case (uartwishbonebridge_rs232phyrx_state)
		1'd1: begin
			if (debug_rx_tick) begin
				debug_rx_data_uartwishbonebridge_rs232phyrx_next_value_ce1 = 1'd1;
			end
		end
		default: begin
		end
...
always @(*) begin
	debug_rx_count_uartwishbonebridge_rs232phyrx_next_value0 = 4'd0;
	case (uartwishbonebridge_rs232phyrx_state)
		1'd1: begin
			if (debug_rx_tick) begin
				debug_rx_count_uartwishbonebridge_rs232phyrx_next_value0 = (debug_rx_count + 1'd1);
			end
		end
		default: begin
			debug_rx_count_uartwishbonebridge_rs232phyrx_next_value0 = 1'd0;
		end
	endcase
end
always @(*) begin
	debug_rx_count_uartwishbonebridge_rs232phyrx_next_value_ce0 = 1'd0;
	case (uartwishbonebridge_rs232phyrx_state)
		1'd1: begin
			if (debug_rx_tick) begin
				debug_rx_count_uartwishbonebridge_rs232phyrx_next_value_ce0 = 1'd1;
			end
		end
		default: begin
			debug_rx_count_uartwishbonebridge_rs232phyrx_next_value_ce0 = 1'd1;
...
always @(*) begin
	debug_rx_data_uartwishbonebridge_rs232phyrx_next_value1 = 8'd0;
	case (uartwishbonebridge_rs232phyrx_state)
		1'd1: begin
			if (debug_rx_tick) begin
				debug_rx_data_uartwishbonebridge_rs232phyrx_next_value1 = {debug_rx_rx, debug_rx_data[7:1]};
			end
		end
		default: begin
		end
...
always @(*) begin
	debug_bytes_count_uartwishbonebridge_next_value0 = 2'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
			if (debug_rx_source_valid) begin
				debug_bytes_count_uartwishbonebridge_next_value0 = (debug_bytes_count + 1'd1);
			end
		end
		2'd3: begin
			if (debug_rx_source_valid) begin
		...
		default: begin
			debug_bytes_count_uartwishbonebridge_next_value0 = 1'd0;
		end
	endcase
end
always @(*) begin
	debug_bytes_count_uartwishbonebridge_next_value_ce0 = 1'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
			if (debug_rx_source_valid) begin
				debug_bytes_count_uartwishbonebridge_next_value_ce0 = 1'd1;
			end
		end
		2'd3: begin
			if (debug_rx_source_valid) begin
...
always @(*) begin
	debug_words_count_uartwishbonebridge_next_value1 = 8'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
		...
		3'd4: begin
			if (debug_wishbone_ack) begin
				debug_words_count_uartwishbonebridge_next_value1 = (debug_words_count + 1'd1);
			end
		end
		3'd5: begin
		end
		...
		default: begin
			debug_words_count_uartwishbonebridge_next_value1 = 1'd0;
		end
	endcase
end
always @(*) begin
	debug_words_count_uartwishbonebridge_next_value_ce1 = 1'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
		...
		3'd4: begin
			if (debug_wishbone_ack) begin
				debug_words_count_uartwishbonebridge_next_value_ce1 = 1'd1;
			end
		end
		3'd5: begin
		end
...
always @(*) begin
	debug_cmd_uartwishbonebridge_next_value2 = 8'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
		...
		default: begin
			if (debug_rx_source_valid) begin
				debug_cmd_uartwishbonebridge_next_value2 = debug_rx_source_payload_data;
			end
		end
	endcase
end
always @(*) begin
	debug_cmd_uartwishbonebridge_next_value_ce2 = 1'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
		...
		default: begin
			if (debug_rx_source_valid) begin
				debug_cmd_uartwishbonebridge_next_value_ce2 = 1'd1;
			end
		end
	endcase
end
...
always @(*) begin
	debug_length_uartwishbonebridge_next_value3 = 8'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
			if (debug_rx_source_valid) begin
				debug_length_uartwishbonebridge_next_value3 = debug_rx_source_payload_data;
			end
		end
		2'd2: begin
		end
...
always @(*) begin
	debug_length_uartwishbonebridge_next_value_ce3 = 1'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
			if (debug_rx_source_valid) begin
				debug_length_uartwishbonebridge_next_value_ce3 = 1'd1;
			end
		end
		2'd2: begin
		end
...
always @(*) begin
	debug_address_uartwishbonebridge_next_value4 = 32'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
			if (debug_rx_source_valid) begin
				debug_address_uartwishbonebridge_next_value4 = {debug_address, debug_rx_source_payload_data};
			end
		end
		2'd3: begin
		end
		3'd4: begin
			if (debug_wishbone_ack) begin
				debug_address_uartwishbonebridge_next_value4 = (debug_address + debug_incr);
			end
		end
		3'd5: begin
		end
...
always @(*) begin
	debug_address_uartwishbonebridge_next_value_ce4 = 1'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
			if (debug_rx_source_valid) begin
				debug_address_uartwishbonebridge_next_value_ce4 = 1'd1;
			end
		end
		2'd3: begin
		end
...
always @(*) begin
	debug_incr_uartwishbonebridge_next_value5 = 1'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
			if (debug_rx_source_valid) begin
				if ((debug_bytes_count == 2'd3)) begin
					if (((debug_cmd == 1'd1) | (debug_cmd == 2'd3))) begin
						debug_incr_uartwishbonebridge_next_value5 = (debug_cmd == 1'd1);
					end else begin
						if (((debug_cmd == 2'd2) | (debug_cmd == 3'd4))) begin
							debug_incr_uartwishbonebridge_next_value5 = (debug_cmd == 2'd2);
						end else begin
						end
					end
				end
...
always @(*) begin
	debug_incr_uartwishbonebridge_next_value_ce5 = 1'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
			if (debug_rx_source_valid) begin
				if ((debug_bytes_count == 2'd3)) begin
					if (((debug_cmd == 1'd1) | (debug_cmd == 2'd3))) begin
						debug_incr_uartwishbonebridge_next_value_ce5 = 1'd1;
					end else begin
						if (((debug_cmd == 2'd2) | (debug_cmd == 3'd4))) begin
							debug_incr_uartwishbonebridge_next_value_ce5 = 1'd1;
						end else begin
...
always @(*) begin
	debug_data_uartwishbonebridge_next_value6 = 32'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
		...
		2'd3: begin
			if (debug_rx_source_valid) begin
				debug_data_uartwishbonebridge_next_value6 = {debug_data, debug_rx_source_payload_data};
			end
		end
		3'd4: begin
		end
		3'd5: begin
			if (debug_wishbone_ack) begin
				debug_data_uartwishbonebridge_next_value6 = debug_wishbone_dat_r;
			end
		end
		3'd6: begin
		end
...
always @(*) begin
	debug_data_uartwishbonebridge_next_value_ce6 = 1'd0;
	case (uartwishbonebridge_state)
		1'd1: begin
		end
		2'd2: begin
		...
		2'd3: begin
			if (debug_rx_source_valid) begin
				debug_data_uartwishbonebridge_next_value_ce6 = 1'd1;
			end
		end
		3'd4: begin
		end
...
assign mgmtsoc_ibex_interface_ibus_dat_r = shared_dat_r;
assign mgmtsoc_ibex_interface_dbus_dat_r = shared_dat_r;
assign debug_wishbone_dat_r = shared_dat_r;
assign mgmtsoc_ibex_interface_ibus_ack = (shared_ack & (grant == 1'd0));
assign mgmtsoc_ibex_interface_dbus_ack = (shared_ack & (grant == 1'd1));
assign debug_wishbone_ack = (shared_ack & (grant == 2'd2));
assign mgmtsoc_ibex_interface_ibus_err = (shared_err & (grant == 1'd0));
assign mgmtsoc_ibex_interface_dbus_err = (shared_err & (grant == 1'd1));
assign debug_wishbone_err = (shared_err & (grant == 2'd2));
assign request = {debug_wishbone_cyc, mgmtsoc_ibex_interface_dbus_cyc, mgmtsoc_ibex_interface_ibus_cyc};
always @(*) begin
	slave_sel = 6'd0;
...
always @(*) begin
	shared_ack = 1'd0;
	shared_ack = (((((dff_bus_ack | sram_bus_ack) | mgmtsoc_litespimmap_bus_ack) | mprj_ack) | hk_ack) | mgmtsoc_wishbone_ack);
	if (done) begin
		shared_ack = 1'd1;
	end
end
assign shared_err = (((((dff_bus_err | sram_bus_err) | mgmtsoc_litespimmap_bus_err) | mprj_err) | hk_err) | mgmtsoc_wishbone_err);
always @(*) begin
	shared_dat_r = 32'd0;
	shared_dat_r = (((((({32{slave_sel_r[0]}} & dff_bus_dat_r) | ({32{slave_sel_r[1]}} & sram_bus_dat_r)) | ({32{slave_sel_r[2]}} & mgmtsoc_litespimmap_bus_dat_r)) | ({32{slave_sel_r[3]}} & mprj_dat_r)) | ({32{slave_sel_r[4]}} & hk_dat_r)) | ({32{slave_sel_r[5]}} & mgmtsoc_wishbone_dat_r));
	if (done) begin
...
assign mgmtsoc_rxtx_r = interface11_bank_bus_dat_w[7:0];
always @(*) begin
	mgmtsoc_rxtx_we = 1'd0;
	if ((csrbank11_sel & (interface11_bank_bus_adr[8:0] == 1'd0))) begin
		mgmtsoc_rxtx_we = (~interface11_bank_bus_we);
	end
end
always @(*) begin
	mgmtsoc_rxtx_re = 1'd0;
	if ((csrbank11_sel & (interface11_bank_bus_adr[8:0] == 1'd0))) begin
		mgmtsoc_rxtx_re = interface11_bank_bus_we;
	end
end
...
assign csrbank11_txfull_w = mgmtsoc_txfull_status;
assign mgmtsoc_txfull_we = csrbank11_txfull_we;
assign csrbank11_rxempty_w = mgmtsoc_rxempty_status;
assign mgmtsoc_rxempty_we = csrbank11_rxempty_we;
always @(*) begin
	mgmtsoc_status_status = 2'd0;
	mgmtsoc_status_status[0] = mgmtsoc_tx0;
	mgmtsoc_status_status[1] = mgmtsoc_rx0;
end
assign csrbank11_ev_status_w = mgmtsoc_status_status[1:0];
assign mgmtsoc_status_we = csrbank11_ev_status_we;
always @(*) begin
	mgmtsoc_pending_status = 2'd0;
	mgmtsoc_pending_status[0] = mgmtsoc_tx1;
	mgmtsoc_pending_status[1] = mgmtsoc_rx1;
end
assign csrbank11_ev_pending_w = mgmtsoc_pending_status[1:0];
assign mgmtsoc_pending_we = csrbank11_ev_pending_we;
assign mgmtsoc_tx2 = mgmtsoc_enable_storage[0];
assign mgmtsoc_rx2 = mgmtsoc_enable_storage[1];
assign csrbank11_ev_enable0_w = mgmtsoc_enable_storage[1:0];
assign csrbank11_txempty_w = mgmtsoc_txempty_status;
assign mgmtsoc_txempty_we = csrbank11_txempty_we;
assign csrbank11_rxfull_w = mgmtsoc_rxfull_status;
assign mgmtsoc_rxfull_we = csrbank11_rxfull_we;
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			comb_array_muxed0 = mgmtsoc_ibex_interface_ibus_adr;
		end
		1'd1: begin
			comb_array_muxed0 = mgmtsoc_ibex_interface_dbus_adr;
		end
		default: begin
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			comb_array_muxed1 = mgmtsoc_ibex_interface_ibus_dat_w;
		end
		1'd1: begin
			comb_array_muxed1 = mgmtsoc_ibex_interface_dbus_dat_w;
		end
		default: begin
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			comb_array_muxed2 = mgmtsoc_ibex_interface_ibus_sel;
		end
		1'd1: begin
			comb_array_muxed2 = mgmtsoc_ibex_interface_dbus_sel;
		end
		default: begin
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			comb_array_muxed3 = mgmtsoc_ibex_interface_ibus_cyc;
		end
		1'd1: begin
			comb_array_muxed3 = mgmtsoc_ibex_interface_dbus_cyc;
		end
		default: begin
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			comb_array_muxed4 = mgmtsoc_ibex_interface_ibus_stb;
		end
		1'd1: begin
			comb_array_muxed4 = mgmtsoc_ibex_interface_dbus_stb;
		end
		default: begin
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			comb_array_muxed5 = mgmtsoc_ibex_interface_ibus_we;
		end
		1'd1: begin
			comb_array_muxed5 = mgmtsoc_ibex_interface_dbus_we;
		end
		default: begin
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			comb_array_muxed6 = mgmtsoc_ibex_interface_ibus_cti;
		end
		1'd1: begin
			comb_array_muxed6 = mgmtsoc_ibex_interface_dbus_cti;
		end
		default: begin
...
always @(*) begin
	...
	case (grant)
		1'd0: begin
			comb_array_muxed7 = mgmtsoc_ibex_interface_ibus_bte;
		end
		1'd1: begin
			comb_array_muxed7 = mgmtsoc_ibex_interface_dbus_bte;
		end
		default: begin
...
assign debug_rx_rx = multiregimpl1_regs1;
...
always @(posedge sys_clk) begin
	...
	obi2wishbone0_state <= obi2wishbone0_next_state;
	if (mgmtsoc_ibex_ibus_conv_addr_obi2wishbone0_next_value_ce0) begin
		mgmtsoc_ibex_ibus_conv_addr <= mgmtsoc_ibex_ibus_conv_addr_obi2wishbone0_next_value0;
	end
	if (mgmtsoc_ibex_ibus_conv_be_obi2wishbone0_next_value_ce1) begin
		mgmtsoc_ibex_ibus_conv_be <= mgmtsoc_ibex_ibus_conv_be_obi2wishbone0_next_value1;
	end
	if (mgmtsoc_ibex_ibus_conv_we_obi2wishbone0_next_value_ce2) begin
		mgmtsoc_ibex_ibus_conv_we <= mgmtsoc_ibex_ibus_conv_we_obi2wishbone0_next_value2;
	end
	if (mgmtsoc_ibex_ibus_conv_wdata_obi2wishbone0_next_value_ce3) begin
		mgmtsoc_ibex_ibus_conv_wdata <= mgmtsoc_ibex_ibus_conv_wdata_obi2wishbone0_next_value3;
	end
	obi2wishbone1_state <= obi2wishbone1_next_state;
	if (mgmtsoc_ibex_dbus_conv_addr_obi2wishbone1_next_value_ce0) begin
		mgmtsoc_ibex_dbus_conv_addr <= mgmtsoc_ibex_dbus_conv_addr_obi2wishbone1_next_value0;
	end
	if (mgmtsoc_ibex_dbus_conv_be_obi2wishbone1_next_value_ce1) begin
		mgmtsoc_ibex_dbus_conv_be <= mgmtsoc_ibex_dbus_conv_be_obi2wishbone1_next_value1;
	end
	if (mgmtsoc_ibex_dbus_conv_we_obi2wishbone1_next_value_ce2) begin
		mgmtsoc_ibex_dbus_conv_we <= mgmtsoc_ibex_dbus_conv_we_obi2wishbone1_next_value2;
	end
	if (mgmtsoc_ibex_dbus_conv_wdata_obi2wishbone1_next_value_ce3) begin
		mgmtsoc_ibex_dbus_conv_wdata <= mgmtsoc_ibex_dbus_conv_wdata_obi2wishbone1_next_value3;
	end
	...
	if (mgmtsoc_tx_clear) begin
		mgmtsoc_tx_pending <= 1'd0;
	end
	mgmtsoc_tx_trigger_d <= mgmtsoc_tx_trigger;
	if ((mgmtsoc_tx_trigger & (~mgmtsoc_tx_trigger_d))) begin
		mgmtsoc_tx_pending <= 1'd1;
	end
	if (mgmtsoc_rx_clear) begin
		mgmtsoc_rx_pending <= 1'd0;
	end
	mgmtsoc_rx_trigger_d <= mgmtsoc_rx_trigger;
	if ((mgmtsoc_rx_trigger & (~mgmtsoc_rx_trigger_d))) begin
		mgmtsoc_rx_pending <= 1'd1;
	end
	if (mgmtsoc_tx_fifo_syncfifo_re) begin
		mgmtsoc_tx_fifo_readable <= 1'd1;
	end else begin
		if (mgmtsoc_tx_fifo_re) begin
			mgmtsoc_tx_fifo_readable <= 1'd0;
		end
	end
	if (((mgmtsoc_tx_fifo_syncfifo_we & mgmtsoc_tx_fifo_syncfifo_writable) & (~mgmtsoc_tx_fifo_replace))) begin
		mgmtsoc_tx_fifo_produce <= (mgmtsoc_tx_fifo_produce + 1'd1);
	end
	if (mgmtsoc_tx_fifo_do_read) begin
		mgmtsoc_tx_fifo_consume <= (mgmtsoc_tx_fifo_consume + 1'd1);
	end
	if (((mgmtsoc_tx_fifo_syncfifo_we & mgmtsoc_tx_fifo_syncfifo_writable) & (~mgmtsoc_tx_fifo_replace))) begin
		if ((~mgmtsoc_tx_fifo_do_read)) begin
			mgmtsoc_tx_fifo_level0 <= (mgmtsoc_tx_fifo_level0 + 1'd1);
		end
	end else begin
		if (mgmtsoc_tx_fifo_do_read) begin
			mgmtsoc_tx_fifo_level0 <= (mgmtsoc_tx_fifo_level0 - 1'd1);
	...
	if (mgmtsoc_rx_fifo_syncfifo_re) begin
		mgmtsoc_rx_fifo_readable <= 1'd1;
	end else begin
		if (mgmtsoc_rx_fifo_re) begin
			mgmtsoc_rx_fifo_readable <= 1'd0;
		end
	end
	if (((mgmtsoc_rx_fifo_syncfifo_we & mgmtsoc_rx_fifo_syncfifo_writable) & (~mgmtsoc_rx_fifo_replace))) begin
		mgmtsoc_rx_fifo_produce <= (mgmtsoc_rx_fifo_produce + 1'd1);
	end
	if (mgmtsoc_rx_fifo_do_read) begin
		mgmtsoc_rx_fifo_consume <= (mgmtsoc_rx_fifo_consume + 1'd1);
	end
	if (((mgmtsoc_rx_fifo_syncfifo_we & mgmtsoc_rx_fifo_syncfifo_writable) & (~mgmtsoc_rx_fifo_replace))) begin
		if ((~mgmtsoc_rx_fifo_do_read)) begin
			mgmtsoc_rx_fifo_level0 <= (mgmtsoc_rx_fifo_level0 + 1'd1);
		end
	end else begin
		if (mgmtsoc_rx_fifo_do_read) begin
			mgmtsoc_rx_fifo_level0 <= (mgmtsoc_rx_fifo_level0 - 1'd1);
	...
	if (debug_tx_count_uartwishbonebridge_rs232phytx_next_value_ce0) begin
		debug_tx_count <= debug_tx_count_uartwishbonebridge_rs232phytx_next_value0;
	end
	if (debug_tx_uartwishbonebridge_rs232phytx_next_value_ce1) begin
		debug_tx <= debug_tx_uartwishbonebridge_rs232phytx_next_value1;
	end
	if (debug_tx_data_uartwishbonebridge_rs232phytx_next_value_ce2) begin
		debug_tx_data <= debug_tx_data_uartwishbonebridge_rs232phytx_next_value2;
	end
	...
	if (debug_rx_count_uartwishbonebridge_rs232phyrx_next_value_ce0) begin
		debug_rx_count <= debug_rx_count_uartwishbonebridge_rs232phyrx_next_value0;
	end
	if (debug_rx_data_uartwishbonebridge_rs232phyrx_next_value_ce1) begin
		debug_rx_data <= debug_rx_data_uartwishbonebridge_rs232phyrx_next_value1;
	end
	uartwishbonebridge_state <= uartwishbonebridge_next_state;
	if (debug_bytes_count_uartwishbonebridge_next_value_ce0) begin
		debug_bytes_count <= debug_bytes_count_uartwishbonebridge_next_value0;
	end
	if (debug_words_count_uartwishbonebridge_next_value_ce1) begin
		debug_words_count <= debug_words_count_uartwishbonebridge_next_value1;
	end
	if (debug_cmd_uartwishbonebridge_next_value_ce2) begin
		debug_cmd <= debug_cmd_uartwishbonebridge_next_value2;
	end
	if (debug_length_uartwishbonebridge_next_value_ce3) begin
		debug_length <= debug_length_uartwishbonebridge_next_value3;
	end
	if (debug_address_uartwishbonebridge_next_value_ce4) begin
		debug_address <= debug_address_uartwishbonebridge_next_value4;
	end
	if (debug_incr_uartwishbonebridge_next_value_ce5) begin
		debug_incr <= debug_incr_uartwishbonebridge_next_value5;
	end
	if (debug_data_uartwishbonebridge_next_value_ce6) begin
		debug_data <= debug_data_uartwishbonebridge_next_value6;
	end
	...
	if (csrbank11_sel) begin
		case (interface11_bank_bus_adr[8:0])
			1'd0: begin
				interface11_bank_bus_dat_r <= mgmtsoc_rxtx_w;
			end
			1'd1: begin
	...
	mgmtsoc_txfull_re <= csrbank11_txfull_re;
	mgmtsoc_rxempty_re <= csrbank11_rxempty_re;
	mgmtsoc_status_re <= csrbank11_ev_status_re;
	if (csrbank11_ev_pending_re) begin
		mgmtsoc_pending_r[1:0] <= csrbank11_ev_pending_r;
	end
	mgmtsoc_pending_re <= csrbank11_ev_pending_re;
	if (csrbank11_ev_enable0_re) begin
		mgmtsoc_enable_storage[1:0] <= csrbank11_ev_enable0_r;
	end
	mgmtsoc_enable_re <= csrbank11_ev_enable0_re;
	mgmtsoc_txempty_re <= csrbank11_txempty_re;
	mgmtsoc_rxfull_re <= csrbank11_rxfull_re;
	...
	if (sys_rst) begin
		...
		mgmtsoc_ibex_ibus_conv_addr <= 32'd0;
		mgmtsoc_ibex_ibus_conv_be <= 4'd0;
		mgmtsoc_ibex_ibus_conv_we <= 1'd0;
		mgmtsoc_ibex_ibus_conv_wdata <= 32'd0;
		mgmtsoc_ibex_dbus_conv_addr <= 32'd0;
		mgmtsoc_ibex_dbus_conv_be <= 4'd0;
		mgmtsoc_ibex_dbus_conv_we <= 1'd0;
		mgmtsoc_ibex_dbus_conv_wdata <= 32'd0;
		serial_tx <= 1'd1;
		mgmtsoc_tx_tick <= 1'd0;
		mgmtsoc_rx_tick <= 1'd0;
		mgmtsoc_rx_rx_d <= 1'd0;
		mgmtsoc_txfull_re <= 1'd0;
		mgmtsoc_rxempty_re <= 1'd0;
		mgmtsoc_tx_pending <= 1'd0;
		mgmtsoc_tx_trigger_d <= 1'd0;
		mgmtsoc_rx_pending <= 1'd0;
		mgmtsoc_rx_trigger_d <= 1'd0;
		mgmtsoc_status_re <= 1'd0;
		mgmtsoc_pending_re <= 1'd0;
		mgmtsoc_pending_r <= 2'd0;
		mgmtsoc_enable_storage <= 2'd0;
		mgmtsoc_enable_re <= 1'd0;
		mgmtsoc_txempty_re <= 1'd0;
		mgmtsoc_rxfull_re <= 1'd0;
		mgmtsoc_tx_fifo_readable <= 1'd0;
		mgmtsoc_tx_fifo_level0 <= 5'd0;
		mgmtsoc_tx_fifo_produce <= 4'd0;
		mgmtsoc_tx_fifo_consume <= 4'd0;
		mgmtsoc_rx_fifo_readable <= 1'd0;
		mgmtsoc_rx_fifo_level0 <= 5'd0;
		mgmtsoc_rx_fifo_produce <= 4'd0;
		mgmtsoc_rx_fifo_consume <= 4'd0;
		dff_bus_ack <= 1'd0;
		sram_bus_ack <= 1'd0;
		...
		obi2wishbone0_state <= 1'd0;
		obi2wishbone1_state <= 1'd0;
...
reg [9:0] memdat_1;
always @(posedge sys_clk) begin
	if (mgmtsoc_tx_fifo_wrport_we)
		storage[mgmtsoc_tx_fifo_wrport_adr] <= mgmtsoc_tx_fifo_wrport_dat_w;
	memdat <= storage[mgmtsoc_tx_fifo_wrport_adr];
end

always @(posedge sys_clk) begin
	if (mgmtsoc_tx_fifo_rdport_re)
		memdat_1 <= storage[mgmtsoc_tx_fifo_rdport_adr];
end

assign mgmtsoc_tx_fifo_wrport_dat_r = memdat;
assign mgmtsoc_tx_fifo_rdport_dat_r = memdat_1;

reg [9:0] storage_1[0:15];
reg [9:0] memdat_2;
reg [9:0] memdat_3;
always @(posedge sys_clk) begin
	if (mgmtsoc_rx_fifo_wrport_we)
		storage_1[mgmtsoc_rx_fifo_wrport_adr] <= mgmtsoc_rx_fifo_wrport_dat_w;
	memdat_2 <= storage_1[mgmtsoc_rx_fifo_wrport_adr];
end

always @(posedge sys_clk) begin
	if (mgmtsoc_rx_fifo_rdport_re)
		memdat_3 <= storage_1[mgmtsoc_rx_fifo_rdport_adr];
end

assign mgmtsoc_rx_fifo_wrport_dat_r = memdat_2;
assign mgmtsoc_rx_fifo_rdport_dat_r = memdat_3;
...
ibex_top #(
	...
	.boot_addr_i(mgmtsoc_ibex3),
	.clk_i(sys_clk),
	.data_err_i(1'd0),
	.data_gnt_i(mgmtsoc_ibex_record_dbus_gnt),
	.data_rdata_i(mgmtsoc_ibex_record_dbus_rdata),
	.data_rvalid_i(mgmtsoc_ibex_record_dbus_rvalid),
	.debug_req_i(1'd0),
	.fetch_enable_i(1'd1),
	.hart_id_i(1'd0),
	.instr_err_i(1'd0),
	.instr_gnt_i(mgmtsoc_ibex_record_ibus_gnt),
	.instr_rdata_i(mgmtsoc_ibex_record_ibus_rdata),
	.instr_rvalid_i(mgmtsoc_ibex_record_ibus_rvalid),
	.irq_external_i(1'd0),
	.irq_fast_i(mgmtsoc_ibex_interrupt),
	.irq_nm_i(1'd0),
	.irq_software_i(1'd0),
	.irq_timer_i(1'd0),
	.rst_ni((~sys_rst)),
	.test_en_i(1'd0),
	.alert_major_o(mgmtsoc_ibex1),
	.alert_minor_o(mgmtsoc_ibex0),
	.core_sleep_o(mgmtsoc_ibex2),
	.data_addr_o(mgmtsoc_ibex_record_dbus_addr),
	.data_be_o(mgmtsoc_ibex_record_dbus_be),
	.data_req_o(mgmtsoc_ibex_record_dbus_req),
	.data_wdata_o(mgmtsoc_ibex_record_dbus_wdata),
	.data_we_o(mgmtsoc_ibex_record_dbus_we),
	.instr_addr_o(mgmtsoc_ibex_record_ibus_addr),
	.instr_req_o(mgmtsoc_ibex_record_ibus_req)
);
