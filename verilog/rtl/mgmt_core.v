...
wire [1:0] hk_bte;
reg hk_err = 1'd0;
reg sys_uart_ports_rx = 1'd0;
reg sys_uart_ports_tx = 1'd1;
...
reg dbg_uart_ports_rx = 1'd0;
reg dbg_uart_ports_tx = 1'd1;
...
reg sys_uart_ports_tx_rs232phy_rs232phytx_next_value1 = 1'd0;
reg sys_uart_ports_tx_rs232phy_rs232phytx_next_value_ce1 = 1'd0;
...
reg dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value1 = 1'd0;
reg dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value_ce1 = 1'd0;
...
always @(*) begin
	dbg_uart_ports_rx = 1'd0;
	if ((debug_in == 1'd1)) begin
		dbg_uart_ports_rx = serial_rx;
	end else begin
	end
end
always @(*) begin
	serial_tx = 1'd0;
	if ((debug_in == 1'd1)) begin
		serial_tx = dbg_uart_ports_tx;
	end else begin
		serial_tx = sys_uart_ports_tx;
	end
end
always @(*) begin
	sys_uart_ports_rx = 1'd0;
	if ((debug_in == 1'd1)) begin
	end else begin
		sys_uart_ports_rx = serial_rx;
	end
end
...
always @(*) begin
	sys_uart_ports_tx_rs232phy_rs232phytx_next_value1 = 1'd0;
	case (rs232phy_rs232phytx_state)
		1'd1: begin
			if (uart_phy_tx_tick) begin
				sys_uart_ports_tx_rs232phy_rs232phytx_next_value1 = uart_phy_tx_data;
			end
		end
		default: begin
			sys_uart_ports_tx_rs232phy_rs232phytx_next_value1 = 1'd1;
			if (uart_phy_tx_sink_valid) begin
				sys_uart_ports_tx_rs232phy_rs232phytx_next_value1 = 1'd0;
			end
		end
...
always @(*) begin
	sys_uart_ports_tx_rs232phy_rs232phytx_next_value_ce1 = 1'd0;
	case (rs232phy_rs232phytx_state)
		1'd1: begin
			if (uart_phy_tx_tick) begin
				sys_uart_ports_tx_rs232phy_rs232phytx_next_value_ce1 = 1'd1;
			end
		end
		default: begin
			sys_uart_ports_tx_rs232phy_rs232phytx_next_value_ce1 = 1'd1;
...
always @(*) begin
	dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value1 = 1'd0;
	case (uartwishbonebridge_rs232phytx_state)
		1'd1: begin
			if (dbg_uart_tx_tick) begin
				dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value1 = dbg_uart_tx_data;
			end
		end
		default: begin
			dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value1 = 1'd1;
			if (dbg_uart_tx_sink_valid) begin
				dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value1 = 1'd0;
			end
		end
...
always @(*) begin
	dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value_ce1 = 1'd0;
	case (uartwishbonebridge_rs232phytx_state)
		1'd1: begin
			if (dbg_uart_tx_tick) begin
				dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value_ce1 = 1'd1;
			end
		end
		default: begin
			dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value_ce1 = 1'd1;
...
always @(posedge sys_clk) begin
	...
	if (sys_uart_ports_tx_rs232phy_rs232phytx_next_value_ce1) begin
		sys_uart_ports_tx <= sys_uart_ports_tx_rs232phy_rs232phytx_next_value1;
	end
	...
	if (dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value_ce1) begin
		dbg_uart_ports_tx <= dbg_uart_ports_tx_uartwishbonebridge_rs232phytx_next_value1;
	end
	...
	multiregimpl0_regs0 <= sys_uart_ports_rx;
	multiregimpl0_regs1 <= multiregimpl0_regs0;
	multiregimpl1_regs0 <= dbg_uart_ports_rx;
