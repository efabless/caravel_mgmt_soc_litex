...
reg [29:0] main_dff_bus_adr = 30'd0;
...
reg [31:0] main_dff_a = 32'd0;
wire main_dff_we;
reg main_dff_en = 1'd0;
...
assign mgmt_soc_dff_A = main_dff_a;
assign main_dff_do = mgmt_soc_dff_Do;
assign mgmt_soc_dff_Di = main_dff_di;
always @(*) begin
//	main_dff_en = 1'd0;
	main_dff_en = mgmt_soc_dff_EN;
	main_dff_en = (main_dff_bus_stb & main_dff_bus_cyc);
end
...
always @(*) begin
	main_dff_bus_adr = 30'd0;
	main_dff_bus_adr = main_dff_a[31:0];
	main_dff_bus_adr = builder_shared_adr;
end
...
assign main_dff_bus_cyc = (builder_shared_cyc & builder_slave_sel[0]);
...
always @(*) begin
	...
	builder_shared_ack = (((((main_dff_bus_ack | main_sram_bus_ack) | main_litespimmap_bus_ack) | main_mprj_ack) | main_hk_ack) | builder_mgmtsoc_wishbone_ack);
	if (builder_done) begin
		builder_shared_ack = 1'd1;
	end
end
assign builder_shared_err = (((((main_dff_bus_err | main_sram_bus_err) | main_litespimmap_bus_err) | main_mprj_err) | main_hk_err) | builder_mgmtsoc_wishbone_err);
always @(*) begin
	builder_shared_dat_r = 32'd0;
	builder_shared_dat_r = (((((({32{builder_slave_sel_r[0]}} & main_dff_bus_dat_r) | ({32{builder_slave_sel_r[1]}} & main_sram_bus_dat_r)) | ({32{builder_slave_sel_r[2]}} & main_litespimmap_bus_dat_r)) | ({32{builder_slave_sel_r[3]}} & main_mprj_dat_r)) | ({32{builder_slave_sel_r[4]}} & main_hk_dat_r)) | ({32{builder_slave_sel_r[5]}} & builder_mgmtsoc_wishbone_dat_r));
	if (builder_done) begin
