...
reg csrbank19_in_re = 1'd0;
wire csrbank19_in_r;
reg csrbank19_in_we = 1'd0;
wire csrbank19_in_w;
reg csrbank19_mode0_re = 1'd0;
wire csrbank19_mode0_r;
reg csrbank19_mode0_we = 1'd0;
wire csrbank19_mode0_w;
reg csrbank19_edge0_re = 1'd0;
wire csrbank19_edge0_r;
reg csrbank19_edge0_we = 1'd0;
wire csrbank19_edge0_w;
reg csrbank19_ev_status_re = 1'd0;
wire csrbank19_ev_status_r;
reg csrbank19_ev_status_we = 1'd0;
wire csrbank19_ev_status_w;
reg csrbank19_ev_pending_re = 1'd0;
wire csrbank19_ev_pending_r;
reg csrbank19_ev_pending_we = 1'd0;
wire csrbank19_ev_pending_w;
reg csrbank19_ev_enable0_re = 1'd0;
wire csrbank19_ev_enable0_r;
reg csrbank19_ev_enable0_we = 1'd0;
wire csrbank19_ev_enable0_w;
wire csrbank19_sel;
wire [13:0] interface20_bank_bus_adr;
wire interface20_bank_bus_we;
wire [31:0] interface20_bank_bus_dat_w;
reg [31:0] interface20_bank_bus_dat_r = 32'd0;
reg csrbank20_out0_re = 1'd0;
wire [2:0] csrbank20_out0_r;
reg csrbank20_out0_we = 1'd0;
wire [2:0] csrbank20_out0_w;
wire csrbank20_sel;
...
assign mprj_cyc_o = (mprj_cyc | hk_cyc);
assign trap = 1'd0;
assign mgmtsoc_bus_error = error;
always @(*) begin
	mgmtsoc_interrupt = 32'd0;
	mgmtsoc_interrupt[1] = mgmtsoc_timer_irq;
	mgmtsoc_interrupt[0] = mgmtsoc_uart_irq;
...
assign csrbank11_load0_w = mgmtsoc_timer_load_storage[31:0];
assign csrbank11_reload0_w = mgmtsoc_timer_reload_storage[31:0];
assign csrbank11_en0_w = mgmtsoc_timer_en_storage;
assign csrbank11_update_value0_w = mgmtsoc_timer_update_value_storage;
assign csrbank11_value_w = mgmtsoc_timer_value_status[31:0];
assign mgmtsoc_timer_value_we = csrbank11_value_we;
assign mgmtsoc_timer_status_status = mgmtsoc_timer_zero0;
assign csrbank11_ev_status_w = mgmtsoc_timer_status_status;
assign mgmtsoc_timer_status_we = csrbank11_ev_status_we;
assign mgmtsoc_timer_pending_status = mgmtsoc_timer_zero1;
assign csrbank11_ev_pending_w = mgmtsoc_timer_pending_status;
assign mgmtsoc_timer_pending_we = csrbank11_ev_pending_we;
assign mgmtsoc_timer_zero2 = mgmtsoc_timer_enable_storage;
assign csrbank11_ev_enable0_w = mgmtsoc_timer_enable_storage;
assign csrbank12_sel = (interface12_bank_bus_adr[13:9] == 4'd12);
assign mgmtsoc_uart_rxtx_r = interface12_bank_bus_dat_w[7:0];
always @(*) begin
	mgmtsoc_uart_rxtx_we = 1'd0;
	if ((csrbank12_sel & (interface12_bank_bus_adr[8:0] == 1'd0))) begin
		mgmtsoc_uart_rxtx_we = (~interface12_bank_bus_we);
	end
end
always @(*) begin
	mgmtsoc_uart_rxtx_re = 1'd0;
	if ((csrbank12_sel & (interface12_bank_bus_adr[8:0] == 1'd0))) begin
		mgmtsoc_uart_rxtx_re = interface12_bank_bus_we;
	end
end
...
assign csrbank12_txfull_w = mgmtsoc_uart_txfull_status;
assign mgmtsoc_uart_txfull_we = csrbank12_txfull_we;
assign csrbank12_rxempty_w = mgmtsoc_uart_rxempty_status;
assign mgmtsoc_uart_rxempty_we = csrbank12_rxempty_we;
always @(*) begin
...
assign csrbank12_ev_status_w = mgmtsoc_uart_status_status[1:0];
assign mgmtsoc_uart_status_we = csrbank12_ev_status_we;
always @(*) begin
...
assign csrbank12_ev_pending_w = mgmtsoc_uart_pending_status[1:0];
assign mgmtsoc_uart_pending_we = csrbank12_ev_pending_we;
assign mgmtsoc_uart_tx2 = mgmtsoc_uart_enable_storage[0];
assign mgmtsoc_uart_rx2 = mgmtsoc_uart_enable_storage[1];
assign csrbank12_ev_enable0_w = mgmtsoc_uart_enable_storage[1:0];
assign csrbank12_txempty_w = mgmtsoc_uart_txempty_status;
assign mgmtsoc_uart_txempty_we = csrbank12_txempty_we;
assign csrbank12_rxfull_w = mgmtsoc_uart_rxfull_status;
assign mgmtsoc_uart_rxfull_we = csrbank12_rxfull_we;
...
assign csrbank13_out0_w = uart_enabled_storage;
...
assign csrbank14_in_w = gpioin0_in_status;
assign gpioin0_in_we = csrbank14_in_we;
assign csrbank14_mode0_w = gpioin0_gpioin0_mode_storage;
assign csrbank14_edge0_w = gpioin0_gpioin0_edge_storage;
assign gpioin0_status_status = gpioin0_i00;
assign csrbank14_ev_status_w = gpioin0_status_status;
assign gpioin0_status_we = csrbank14_ev_status_we;
assign gpioin0_pending_status = gpioin0_i01;
assign csrbank14_ev_pending_w = gpioin0_pending_status;
assign gpioin0_pending_we = csrbank14_ev_pending_we;
assign gpioin0_i02 = gpioin0_enable_storage;
assign csrbank14_ev_enable0_w = gpioin0_enable_storage;
...
assign csrbank15_in_w = gpioin1_in_status;
assign gpioin1_in_we = csrbank15_in_we;
assign csrbank15_mode0_w = gpioin1_gpioin1_mode_storage;
assign csrbank15_edge0_w = gpioin1_gpioin1_edge_storage;
assign gpioin1_status_status = gpioin1_i00;
assign csrbank15_ev_status_w = gpioin1_status_status;
assign gpioin1_status_we = csrbank15_ev_status_we;
assign gpioin1_pending_status = gpioin1_i01;
assign csrbank15_ev_pending_w = gpioin1_pending_status;
assign gpioin1_pending_we = csrbank15_ev_pending_we;
assign gpioin1_i02 = gpioin1_enable_storage;
assign csrbank15_ev_enable0_w = gpioin1_enable_storage;
...
assign csrbank16_in_w = gpioin2_in_status;
assign gpioin2_in_we = csrbank16_in_we;
assign csrbank16_mode0_w = gpioin2_gpioin2_mode_storage;
assign csrbank16_edge0_w = gpioin2_gpioin2_edge_storage;
assign gpioin2_status_status = gpioin2_i00;
assign csrbank16_ev_status_w = gpioin2_status_status;
assign gpioin2_status_we = csrbank16_ev_status_we;
assign gpioin2_pending_status = gpioin2_i01;
assign csrbank16_ev_pending_w = gpioin2_pending_status;
assign gpioin2_pending_we = csrbank16_ev_pending_we;
assign gpioin2_i02 = gpioin2_enable_storage;
assign csrbank16_ev_enable0_w = gpioin2_enable_storage;
...
assign csrbank17_in_w = gpioin3_in_status;
assign gpioin3_in_we = csrbank17_in_we;
assign csrbank17_mode0_w = gpioin3_gpioin3_mode_storage;
assign csrbank17_edge0_w = gpioin3_gpioin3_edge_storage;
assign gpioin3_status_status = gpioin3_i00;
assign csrbank17_ev_status_w = gpioin3_status_status;
assign gpioin3_status_we = csrbank17_ev_status_we;
assign gpioin3_pending_status = gpioin3_i01;
assign csrbank17_ev_pending_w = gpioin3_pending_status;
assign gpioin3_pending_we = csrbank17_ev_pending_we;
assign gpioin3_i02 = gpioin3_enable_storage;
assign csrbank17_ev_enable0_w = gpioin3_enable_storage;
...
assign csrbank18_in_w = gpioin4_in_status;
assign gpioin4_in_we = csrbank18_in_we;
assign csrbank18_mode0_w = gpioin4_gpioin4_mode_storage;
assign csrbank18_edge0_w = gpioin4_gpioin4_edge_storage;
assign gpioin4_status_status = gpioin4_i00;
assign csrbank18_ev_status_w = gpioin4_status_status;
assign gpioin4_status_we = csrbank18_ev_status_we;
assign gpioin4_pending_status = gpioin4_i01;
assign csrbank18_ev_pending_w = gpioin4_pending_status;
assign gpioin4_pending_we = csrbank18_ev_pending_we;
assign gpioin4_i02 = gpioin4_enable_storage;
assign csrbank18_ev_enable0_w = gpioin4_enable_storage;
assign csrbank19_sel = (interface19_bank_bus_adr[13:9] == 5'd19);
assign csrbank19_in_r = interface19_bank_bus_dat_w[0];
always @(*) begin
	csrbank19_in_we = 1'd0;
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank19_in_we = (~interface19_bank_bus_we);
	end
end
always @(*) begin
	csrbank19_in_re = 1'd0;
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank19_in_re = interface19_bank_bus_we;
	end
end
assign csrbank19_mode0_r = interface19_bank_bus_dat_w[0];
always @(*) begin
	csrbank19_mode0_we = 1'd0;
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank19_mode0_we = (~interface19_bank_bus_we);
	end
end
always @(*) begin
	csrbank19_mode0_re = 1'd0;
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank19_mode0_re = interface19_bank_bus_we;
	end
end
assign csrbank19_edge0_r = interface19_bank_bus_dat_w[0];
always @(*) begin
	csrbank19_edge0_re = 1'd0;
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank19_edge0_re = interface19_bank_bus_we;
	end
end
always @(*) begin
	csrbank19_edge0_we = 1'd0;
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank19_edge0_we = (~interface19_bank_bus_we);
	end
end
assign csrbank19_ev_status_r = interface19_bank_bus_dat_w[0];
always @(*) begin
	csrbank19_ev_status_we = 1'd0;
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 2'd3))) begin
		csrbank19_ev_status_we = (~interface19_bank_bus_we);
	end
end
always @(*) begin
...
assign csrbank19_ev_pending_r = interface19_bank_bus_dat_w[0];
always @(*) begin
	csrbank19_ev_pending_we = 1'd0;
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 3'd4))) begin
		csrbank19_ev_pending_we = (~interface19_bank_bus_we);
	end
end
always @(*) begin
...
assign csrbank19_ev_enable0_r = interface19_bank_bus_dat_w[0];
always @(*) begin
	csrbank19_ev_enable0_re = 1'd0;
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 3'd5))) begin
...
always @(*) begin
	...
	if ((csrbank19_sel & (interface19_bank_bus_adr[8:0] == 3'd5))) begin
		csrbank19_ev_enable0_we = (~interface19_bank_bus_we);
	end
end
assign csrbank19_in_w = gpioin5_in_status;
assign gpioin5_in_we = csrbank19_in_we;
assign csrbank19_mode0_w = gpioin5_gpioin5_mode_storage;
assign csrbank19_edge0_w = gpioin5_gpioin5_edge_storage;
assign gpioin5_status_status = gpioin5_i00;
assign csrbank19_ev_status_w = gpioin5_status_status;
assign gpioin5_status_we = csrbank19_ev_status_we;
assign gpioin5_pending_status = gpioin5_i01;
assign csrbank19_ev_pending_w = gpioin5_pending_status;
assign gpioin5_pending_we = csrbank19_ev_pending_we;
assign gpioin5_i02 = gpioin5_enable_storage;
assign csrbank19_ev_enable0_w = gpioin5_enable_storage;
assign csrbank20_sel = (interface20_bank_bus_adr[13:9] == 5'd20);
assign csrbank20_out0_r = interface20_bank_bus_dat_w[2:0];
always @(*) begin
	csrbank20_out0_we = 1'd0;
	if ((csrbank20_sel & (interface20_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank20_out0_we = (~interface20_bank_bus_we);
	end
end
always @(*) begin
	csrbank20_out0_re = 1'd0;
	if ((csrbank20_sel & (interface20_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank20_out0_re = interface20_bank_bus_we;
	end
end
assign csrbank20_out0_w = user_irq_ena_storage[2:0];
...
always @(posedge sys_clk) begin
	...
	if (csrbank11_load0_re) begin
		mgmtsoc_timer_load_storage[31:0] <= csrbank11_load0_r;
	end
	mgmtsoc_timer_load_re <= csrbank11_load0_re;
	if (csrbank11_reload0_re) begin
		mgmtsoc_timer_reload_storage[31:0] <= csrbank11_reload0_r;
	end
	mgmtsoc_timer_reload_re <= csrbank11_reload0_re;
	if (csrbank11_en0_re) begin
		mgmtsoc_timer_en_storage <= csrbank11_en0_r;
	end
	mgmtsoc_timer_en_re <= csrbank11_en0_re;
	if (csrbank11_update_value0_re) begin
		mgmtsoc_timer_update_value_storage <= csrbank11_update_value0_r;
	end
	mgmtsoc_timer_update_value_re <= csrbank11_update_value0_re;
	mgmtsoc_timer_value_re <= csrbank11_value_re;
	mgmtsoc_timer_status_re <= csrbank11_ev_status_re;
	if (csrbank11_ev_pending_re) begin
		mgmtsoc_timer_pending_r <= csrbank11_ev_pending_r;
	end
	mgmtsoc_timer_pending_re <= csrbank11_ev_pending_re;
	if (csrbank11_ev_enable0_re) begin
		mgmtsoc_timer_enable_storage <= csrbank11_ev_enable0_r;
	end
	mgmtsoc_timer_enable_re <= csrbank11_ev_enable0_re;
	interface12_bank_bus_dat_r <= 1'd0;
	if (csrbank12_sel) begin
		case (interface12_bank_bus_adr[8:0])
			1'd0: begin
				interface12_bank_bus_dat_r <= mgmtsoc_uart_rxtx_w;
			end
			1'd1: begin
	...
	mgmtsoc_uart_txfull_re <= csrbank12_txfull_re;
	mgmtsoc_uart_rxempty_re <= csrbank12_rxempty_re;
	mgmtsoc_uart_status_re <= csrbank12_ev_status_re;
	if (csrbank12_ev_pending_re) begin
		mgmtsoc_uart_pending_r[1:0] <= csrbank12_ev_pending_r;
	end
	mgmtsoc_uart_pending_re <= csrbank12_ev_pending_re;
	if (csrbank12_ev_enable0_re) begin
		mgmtsoc_uart_enable_storage[1:0] <= csrbank12_ev_enable0_r;
	end
	mgmtsoc_uart_enable_re <= csrbank12_ev_enable0_re;
	mgmtsoc_uart_txempty_re <= csrbank12_txempty_re;
	mgmtsoc_uart_rxfull_re <= csrbank12_rxfull_re;
	...
	if (csrbank13_out0_re) begin
		uart_enabled_storage <= csrbank13_out0_r;
	end
	uart_enabled_re <= csrbank13_out0_re;
	...
	gpioin0_in_re <= csrbank14_in_re;
	if (csrbank14_mode0_re) begin
		gpioin0_gpioin0_mode_storage <= csrbank14_mode0_r;
	end
	gpioin0_gpioin0_mode_re <= csrbank14_mode0_re;
	if (csrbank14_edge0_re) begin
		gpioin0_gpioin0_edge_storage <= csrbank14_edge0_r;
	end
	gpioin0_gpioin0_edge_re <= csrbank14_edge0_re;
	gpioin0_status_re <= csrbank14_ev_status_re;
	if (csrbank14_ev_pending_re) begin
		gpioin0_pending_r <= csrbank14_ev_pending_r;
	end
	gpioin0_pending_re <= csrbank14_ev_pending_re;
	if (csrbank14_ev_enable0_re) begin
		gpioin0_enable_storage <= csrbank14_ev_enable0_r;
	end
	gpioin0_enable_re <= csrbank14_ev_enable0_re;
	...
	gpioin1_in_re <= csrbank15_in_re;
	if (csrbank15_mode0_re) begin
		gpioin1_gpioin1_mode_storage <= csrbank15_mode0_r;
	end
	gpioin1_gpioin1_mode_re <= csrbank15_mode0_re;
	if (csrbank15_edge0_re) begin
		gpioin1_gpioin1_edge_storage <= csrbank15_edge0_r;
	end
	gpioin1_gpioin1_edge_re <= csrbank15_edge0_re;
	gpioin1_status_re <= csrbank15_ev_status_re;
	if (csrbank15_ev_pending_re) begin
		gpioin1_pending_r <= csrbank15_ev_pending_r;
	end
	gpioin1_pending_re <= csrbank15_ev_pending_re;
	if (csrbank15_ev_enable0_re) begin
		gpioin1_enable_storage <= csrbank15_ev_enable0_r;
	end
	gpioin1_enable_re <= csrbank15_ev_enable0_re;
	...
	gpioin2_in_re <= csrbank16_in_re;
	if (csrbank16_mode0_re) begin
		gpioin2_gpioin2_mode_storage <= csrbank16_mode0_r;
	end
	gpioin2_gpioin2_mode_re <= csrbank16_mode0_re;
	if (csrbank16_edge0_re) begin
		gpioin2_gpioin2_edge_storage <= csrbank16_edge0_r;
	end
	gpioin2_gpioin2_edge_re <= csrbank16_edge0_re;
	gpioin2_status_re <= csrbank16_ev_status_re;
	if (csrbank16_ev_pending_re) begin
		gpioin2_pending_r <= csrbank16_ev_pending_r;
	end
	gpioin2_pending_re <= csrbank16_ev_pending_re;
	if (csrbank16_ev_enable0_re) begin
		gpioin2_enable_storage <= csrbank16_ev_enable0_r;
	end
	gpioin2_enable_re <= csrbank16_ev_enable0_re;
	...
	gpioin3_in_re <= csrbank17_in_re;
	if (csrbank17_mode0_re) begin
		gpioin3_gpioin3_mode_storage <= csrbank17_mode0_r;
	end
	gpioin3_gpioin3_mode_re <= csrbank17_mode0_re;
	if (csrbank17_edge0_re) begin
		gpioin3_gpioin3_edge_storage <= csrbank17_edge0_r;
	end
	gpioin3_gpioin3_edge_re <= csrbank17_edge0_re;
	gpioin3_status_re <= csrbank17_ev_status_re;
	if (csrbank17_ev_pending_re) begin
		gpioin3_pending_r <= csrbank17_ev_pending_r;
	end
	gpioin3_pending_re <= csrbank17_ev_pending_re;
	if (csrbank17_ev_enable0_re) begin
		gpioin3_enable_storage <= csrbank17_ev_enable0_r;
	end
	gpioin3_enable_re <= csrbank17_ev_enable0_re;
	...
	gpioin4_in_re <= csrbank18_in_re;
	if (csrbank18_mode0_re) begin
		gpioin4_gpioin4_mode_storage <= csrbank18_mode0_r;
	end
	gpioin4_gpioin4_mode_re <= csrbank18_mode0_re;
	if (csrbank18_edge0_re) begin
		gpioin4_gpioin4_edge_storage <= csrbank18_edge0_r;
	end
	gpioin4_gpioin4_edge_re <= csrbank18_edge0_re;
	gpioin4_status_re <= csrbank18_ev_status_re;
	if (csrbank18_ev_pending_re) begin
		gpioin4_pending_r <= csrbank18_ev_pending_r;
	end
	gpioin4_pending_re <= csrbank18_ev_pending_re;
	if (csrbank18_ev_enable0_re) begin
		gpioin4_enable_storage <= csrbank18_ev_enable0_r;
	end
	gpioin4_enable_re <= csrbank18_ev_enable0_re;
	interface19_bank_bus_dat_r <= 1'd0;
	if (csrbank19_sel) begin
		case (interface19_bank_bus_adr[8:0])
			1'd0: begin
				interface19_bank_bus_dat_r <= csrbank19_in_w;
			end
			1'd1: begin
				interface19_bank_bus_dat_r <= csrbank19_mode0_w;
			end
			2'd2: begin
				interface19_bank_bus_dat_r <= csrbank19_edge0_w;
			end
			2'd3: begin
	...
	gpioin5_in_re <= csrbank19_in_re;
	if (csrbank19_mode0_re) begin
		gpioin5_gpioin5_mode_storage <= csrbank19_mode0_r;
	end
	gpioin5_gpioin5_mode_re <= csrbank19_mode0_re;
	if (csrbank19_edge0_re) begin
		gpioin5_gpioin5_edge_storage <= csrbank19_edge0_r;
	end
	gpioin5_gpioin5_edge_re <= csrbank19_edge0_re;
	gpioin5_status_re <= csrbank19_ev_status_re;
	if (csrbank19_ev_pending_re) begin
		gpioin5_pending_r <= csrbank19_ev_pending_r;
	end
	gpioin5_pending_re <= csrbank19_ev_pending_re;
	if (csrbank19_ev_enable0_re) begin
		gpioin5_enable_storage <= csrbank19_ev_enable0_r;
	end
	gpioin5_enable_re <= csrbank19_ev_enable0_re;
	interface20_bank_bus_dat_r <= 1'd0;
	if (csrbank20_sel) begin
		case (interface20_bank_bus_adr[8:0])
			1'd0: begin
				interface20_bank_bus_dat_r <= csrbank20_out0_w;
			end
		endcase
	end
	if (csrbank20_out0_re) begin
		user_irq_ena_storage[2:0] <= csrbank20_out0_r;
	end
	user_irq_ena_re <= csrbank20_out0_re;
	if (sys_rst) begin
