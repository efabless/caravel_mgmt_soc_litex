...
reg [29:0] mprj_adr = 30'd0;
reg [31:0] mprj_dat_w = 32'd0;
wire [31:0] mprj_dat_r;
reg [3:0] mprj_sel = 4'd0;
reg mprj_cyc = 1'd0;
reg mprj_stb = 1'd0;
wire mprj_ack;
reg mprj_we = 1'd0;
...
always @(*) begin
	...
	mgmtsoc_interrupt[1] = gpioin0_gpioin0_irq;
	mgmtsoc_interrupt[2] = gpioin1_gpioin1_irq;
	mgmtsoc_interrupt[3] = gpioin2_gpioin2_irq;
	mgmtsoc_interrupt[4] = gpioin3_gpioin3_irq;
	mgmtsoc_interrupt[5] = gpioin4_gpioin4_irq;
	mgmtsoc_interrupt[6] = gpioin5_gpioin5_irq;
end
...
assign request = {debug_wishbone_cyc, mgmtsoc_dbus_dbus_cyc, mgmtsoc_ibus_ibus_cyc};
always @(*) begin
	slave_sel = 5'd0;
...
assign mgmtsoc_wishbone_cyc = (shared_cyc & slave_sel[4]);
always @(*) begin
	shared_ack = 1'd0;
	shared_ack = ((((mgmtsoc_vexriscv_debug_bus_ack | dff_bus_ack) | sram_bus_ack) | mgmtsoc_litespimmap_bus_ack) | mgmtsoc_wishbone_ack);
	if (done) begin
		shared_ack = 1'd1;
	end
end
assign shared_err = ((((mgmtsoc_vexriscv_debug_bus_err | dff_bus_err) | sram_bus_err) | mgmtsoc_litespimmap_bus_err) | mgmtsoc_wishbone_err);
always @(*) begin
	shared_dat_r = 32'd0;
	shared_dat_r = ((((({32{slave_sel_r[0]}} & mgmtsoc_vexriscv_debug_bus_dat_r) | ({32{slave_sel_r[1]}} & dff_bus_dat_r)) | ({32{slave_sel_r[2]}} & sram_bus_dat_r)) | ({32{slave_sel_r[3]}} & mgmtsoc_litespimmap_bus_dat_r)) | ({32{slave_sel_r[4]}} & mgmtsoc_wishbone_dat_r));
	if (done) begin
