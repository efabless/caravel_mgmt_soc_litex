...
class MGMTSoC(SoCMini):
    ...
    def __init__(self, sys_clk_freq=int(10e6), **kwargs ):
        ...
        # # mgmt_soc_dff = platform.request("mgmt_soc_dff")
        # self.comb += mgmt_soc_dff.WE.eq(dff.we | dff2.we)
        # self.comb += mgmt_soc_dff.A.eq(dff.bus.adr | dff2.bus.adr)
        # self.comb += dff2.do.eq(mgmt_soc_dff.Do)
        # self.comb += dff.do.eq(mgmt_soc_dff.Do)
        # self.comb += mgmt_soc_dff.Di.eq(dff.di | dff2.di)
        # self.comb += mgmt_soc_dff.EN.eq(dff.en | dff2.en)
