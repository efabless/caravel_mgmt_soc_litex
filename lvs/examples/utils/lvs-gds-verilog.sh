...
if [ -f  ./reports/lvs-compare-${1%.gds}-gds-vs-verilog.out ]; then
\mv ./reports/lvs-compare-${1%.gds}-gds-vs-verilog.out ./reports/lvs-compare-${1%.gds}-gds-vs-verilog.out.last
fi
